...
```
System:
  Host: rose Kernel: 6.6.0-rc1 arch: x86_64 bits: 64 compiler: gcc v: 13.2.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\gv9r50g6asdrm24slnn9ldiqk9nha27l-initrd-linux-6.6-initrd.efi
    init=/nix/store/6fg03rirqkhssf1dr6sdb1zp0jrbrj9w-nixos-system-rose-24.05.20240709.249fbde/init
...
Machine:
  ...
  Mobo: Supermicro model: H12DSG-O-CPU v: 1.01A serial: VM227S602140
    uuid: e7b77c00-4ef1-11ed-8000-3cecefea4bb2 UEFI: American Megatrends v: 2.4 date: 04/22/2022
Memory:
  System RAM: total: 2 TiB available: 1.96 TiB used: 1.48 TiB (75.7%)
...
CPU:
  ...
  Topology: cpus: 2x cores: 24 tpc: 2 threads: 48 smt: enabled cache: L1: 2x 1.5 MiB (3 MiB)
    ...
    desc: 4x32 MiB
  Speed (MHz): avg: 1559 high: 2650 min/max: 1500/3631 boost: enabled base/boost: 2650/3625
    ...
    43: 1500 44: 1500 45: 1500 46: 2650 47: 1500 48: 1500 49: 1500 50: 1500 51: 1500 52: 1500
    53: 1500 54: 1500 55: 1500 56: 1500 57: 1500 58: 1500 59: 1500 60: 2650 61: 1500 62: 1500
    63: 1500 64: 1500 65: 1500 66: 1500 67: 1500 68: 1500 69: 1500 70: 1500 71: 2650 72: 1500
    73: 1500 74: 1500 75: 1500 76: 1500 77: 1500 78: 2650 79: 1500 80: 1500 81: 1500 82: 2650
    83: 1500 84: 1500 85: 1500 86: 1500 87: 1500 88: 1500 89: 1500 90: 1500 91: 1500 92: 1500
    93: 1500 94: 1500 95: 1500 96: 1500 bogomips: 508791
...
Graphics:
  Device-1: ASPEED Graphics Family vendor: Super Micro driver: ast v: kernel ports:
    active: Virtual-1 off: VGA-1 empty: none bus-ID: 62:00.0 chip-ID: 1a03:2000 class-ID: 0300
  ...
  Monitor-2: Virtual-1 size-res: N/A in console modes: max: 1920x1200 min: 640x480
...
Network:
  Device-1: Broadcom BCM57412 NetXtreme-E 10Gb RDMA Ethernet driver: bnxt_en v: kernel pcie: gen: 3
    speed: 8 GT/s lanes: 8 port: N/A bus-ID: c2:00.0 chip-ID: 14e4:16d6 class-ID: 0200 temp: 53.0 C
  ...
  IF-ID-1: docker0 state: down mac: 02:42:8f:ec:9d:95
...
RAID:
  ...
  Device-2: zroot type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 642 GiB
    allocated: 1.11 TiB zfs-fs: size: 1.68 TiB free: 587.49 GiB
  Components: Online:
  1: nvme1n1p2 maj-min: 259:4 size: 1.75 TiB
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.36 TiB used: 1.28 TiB (38.1%)
  ...
  SMART: yes health: PASSED on: 1y 161d 21h cycles: 72 read-units: 11,227,200 [5.74 TB]
    written-units: 73,475,059 [37.6 TB]
  ID-2: /dev/nvme1n1 maj-min: 259:1 vendor: Samsung model: MZQL21T9HCJR-00A07 size: 1.75 TiB
    block-size: physical: 4096 B logical: 512 B speed: 63.2 Gb/s lanes: 4 tech: SSD
    serial: S64GNA0T724987 fw-rev: GDC5602Q temp: 35.9 C scheme: GPT
  SMART: yes health: PASSED on: 1y 161d 21h cycles: 72 read-units: 99,575,095 [50.9 TB]
    written-units: 116,226,635 [59.5 TB]
Partition:
  ID-1: / raw-size: N/A size: 1.55 TiB used: 995.69 GiB (62.9%) fs: zfs logical: zroot/root/nixos
  ...
  ID-4: /tmp raw-size: N/A size: 587.49 GiB used: 1.2 MiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu-1: 34 C cpu-2: 41 C mobo: 39 C
  Fan Speeds (rpm): cpu: 10500 fan-2: 10500 fan-3: 10500 fan-4: 10360 fan-5: 10500 fan-6: 10500
    fan-7: 10500 fan-8: 10500 fan-9: 1960 fan-16: 1820
  Power: 12v: 12.112 5v: 5.020 3.3v: 3.259 vbat: N/A dimm-p1: 1.207 dimm-p2: 1.228
  Src: lm-sensors System Temperatures: cpu: 43.2 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 1704 Power: uptime: 1h 35m states: freeze,mem suspend: s2idle wakeups: 0
    hibernate: disabled image: 801.56 GiB Init: systemd v: 255 default: graphical tool: systemctl
  Packages: pm: nix-default pkgs: 0 pm: nix-sys pkgs: 910 libs: 220 pm: nix-usr pkgs: 0
