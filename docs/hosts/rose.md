...
```
System:
  Host: rose Kernel: 6.9.0-rc7 arch: x86_64 bits: 64 compiler: gcc v: 14.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\z6a40lr1973qyzmkv4h3kn5sr5jh67kp-initrd-linux-6.9-initrd.efi
    init=/nix/store/zlcgzk5j2fzrnzvwhpknhbp7l1wyqlgh-nixos-system-rose-25.11.20260123.ac3d985/init
    amd_iommu=on console=ttyS0,115200 console=tty0 hugepagesz=1GB hugepages=0 hugepagesz=2MB
    hugepages=768000 amd_iommu=off kvm_amd.sev=1 kvm_amd.sev_es=1 kvm_amd.sev_snp=1
    sp5100_tco.blacklist=yes kvm.gmem_2m_enabled=1 console=ttyS1,115200n8 console=tty1 nohibernate
    loglevel=4 lsm=landlock,yama,bpf
  Console: N/A DM: LightDM v: 1.32.0 Distro: NixOS 25.11 (Xantusia)
Machine:
  Type: Server System: sysGen www.sysgen.de product: Super Server v: 0123456789 serial: 0123456789
    Chassis: type: 17 v: 0123456789 serial: 0123456789
  Mobo: Supermicro model: H12DSG-O-CPU v: 1.01A serial: UM21BS602035
    uuid: 39fba800-9244-11ef-8000-3cecefea4bb2 UEFI: American Megatrends v: 3.1 date: 02/21/2025
Memory:
  System RAM: total: 2 TiB available: 1.96 TiB used: 298.6 GiB (14.9%)
...
CPU:
  Info: model: AMD EPYC 7413 socket: SP3 bits: 64 type: MT MCP SMP arch: Zen 3 gen: 3 level: v3
    note: check built: 2021-22 process: TSMC n7 (7nm) family: 0x19 (25) model-id: 1 stepping: 1
    microcode: 0xA0011DE
  Topology: cpus: 2x dies: 1 clusters: 1 cores: 24 threads: 48 tpc: 2 smt: enabled cache:
    L1: 2x 1.5 MiB (3 MiB) desc: d-24x32 KiB; i-24x32 KiB L2: 2x 12 MiB (24 MiB) desc: 24x512 KiB
    L3: 2x 128 MiB (256 MiB) desc: 4x32 MiB
  Speed (MHz): avg: 2075 high: 2650 min/max: 1500/3631 boost: enabled base/boost: 2650/3625
    ...
    23: 1500 24: 1500 25: 2650 26: 2650 27: 2650 28: 2650 29: 2650 30: 2650 31: 2650 32: 2650
    33: 2650 34: 2650 35: 2650 36: 2650 37: 2650 38: 2650 39: 2650 40: 2650 41: 2650 42: 2650
    43: 2650 44: 2650 45: 2650 46: 2650 47: 2650 48: 2650 49: 1500 50: 1500 51: 1500 52: 1500
    ...
    73: 2650 74: 2650 75: 2650 76: 2650 77: 2650 78: 2650 79: 2650 80: 2650 81: 2650 82: 2650
    83: 2650 84: 2650 85: 2650 86: 2650 87: 2650 88: 2650 89: 2650 90: 2650 91: 2650 92: 2650
    93: 2650 94: 2650 95: 2650 96: 2650 bogomips: 508791
...
Graphics:
  Device-1: ASPEED Graphics Family vendor: Super Micro driver: ast v: kernel ports: active: VGA-1
    empty: Virtual-1 bus-ID: 63:00.0 chip-ID: 1a03:2000 class-ID: 0300
...
Network:
  Device-1: Intel Ethernet E810-C for QSFP driver: ice v: kernel pcie: gen: 4 speed: 16 GT/s
    lanes: 16 port: N/A bus-ID: 01:00.0 chip-ID: 8086:1592 class-ID: 0200 temp: 57.0 C
  IF: enp1s0f0np0 state: up speed: 100000 Mbps duplex: full mac: b4:96:91:aa:95:68
  IP v6: fe80::b696:91ff:feaa:9568/64 virtual: proto kernel_ll scope: link
  Device-2: Intel Ethernet E810-C for QSFP driver: ice v: kernel pcie: gen: 4 speed: 16 GT/s
    lanes: 16 port: N/A bus-ID: 01:00.1 chip-ID: 8086:1592 class-ID: 0200
  IF: enp1s0f1np1 state: down mac: b4:96:91:aa:95:69
  Device-3: Broadcom BCM57412 NetXtreme-E 10Gb RDMA Ethernet driver: bnxt_en v: kernel pcie:
    gen: 3 speed: 8 GT/s lanes: 8 port: N/A bus-ID: a1:00.0 chip-ID: 14e4:16d6 class-ID: 0200
    temp: 58.0 C
  IF: enp161s0f0np0 state: up speed: 10000 Mbps duplex: full mac: 84:16:0c:cd:69:40
  IP v4: 131.159.102.21/24 type: dynamic scope: global
  IP v4: 192.168.1.3/24 scope: global
  ...
  Device-4: Broadcom BCM57412 NetXtreme-E 10Gb RDMA Ethernet driver: bnxt_en v: kernel pcie:
    gen: 3 speed: 8 GT/s lanes: 8 port: N/A bus-ID: a1:00.1 chip-ID: 14e4:16d6 class-ID: 0200
  IF: enp161s0f1np1 state: down mac: 84:16:0c:cd:69:41
  ...
  IF-ID-1: docker0 state: down mac: 7a:48:80:6d:92:23
...
Bluetooth:
  Device-1: Insyde RNDIS/Ethernet Gadget driver: rndis_host v: kernel type: USB rev: 2.0
    speed: 480 Mb/s lanes: 1 mode: 2.0 bus-ID: 1-1.1:3 chip-ID: 0b1f:03ee class-ID: 0a00
  Report: This feature requires one of these tools: hciconfig/bt-adapter
RAID:
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 529 GiB
    allocated: 1.22 TiB zfs-fs: size: 1.68 TiB free: 473.55 GiB
  Components: Online:
  1: nvme1n1p2 maj-min: 259:4 size: 1.75 TiB
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.43 TiB used: 1.09 TiB (31.8%)
  ID-1: /dev/nvme0n1 maj-min: 259:0 vendor: Samsung model: MZQL21T9HCJR-00A07 size: 1.75 TiB
    ...
    serial: S64GNA0T724986 fw-rev: GDC5602Q temp: 32.9 C scheme: GPT
  SMART: yes health: PASSED on: 2y 240d 21h cycles: 99 read-units: 14,642,669 [7.49 TB]
    written-units: 73,478,094 [37.6 TB]
  ID-2: /dev/nvme1n1 maj-min: 259:2 vendor: Samsung model: MZQL21T9HCJR-00A07 size: 1.75 TiB
    block-size: physical: 4096 B logical: 512 B speed: 63.2 Gb/s lanes: 4 tech: SSD
    serial: S64GNA0T724987 fw-rev: GDC5602Q temp: 32.9 C scheme: GPT
  SMART: yes health: PASSED on: 2y 240d 21h cycles: 99 read-units: 137,288,440 [70.2 TB]
    written-units: 154,435,321 [79.0 TB]
Partition:
  ID-1: / raw-size: N/A size: 1.55 TiB used: 1.09 TiB (70.2%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 30.8 MiB (3.0%) fs: vfat
    block-size: 512 B dev: /dev/nvme1n1p1 maj-min: 259:3
  ID-3: /home raw-size: N/A size: 3.47 TiB used: 2.54 TiB (73.3%) fs: nfs4
    remote: nfs:/export/home
  ID-4: /tmp raw-size: N/A size: 473.57 GiB used: 24.1 MiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu-1: 57 C cpu-2: 53 C mobo: 44 C
  Fan Speeds (rpm): fan-1: 3220 fan-2: 3220 fan-3: 3220 fan-4: 3220 fan-5: 3220 fan-6: 3220
    fan-7: 3220 fan-8: 3220 fan-9: 1820 fan-16: 1400
  Power: 12v: 12.112 5v: 5.020 3.3v: 3.276 vbat: N/A dimm-p1: 1.207 dimm-p2: 1.214
  Src: lm-sensors System Temperatures: cpu: 57.2 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 1344 Power: uptime: 22d 13h 30m states: freeze,mem suspend: s2idle wakeups: 0
    hibernate: disabled image: 801.55 GiB services: upowerd,xfce4-power-manager Init: systemd v: 258
