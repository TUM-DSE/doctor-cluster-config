...
System:
  Host: rose Kernel: 6.9.0-rc7 arch: x86_64 bits: 64 compiler: gcc v: 14.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\gxyb0s2v93jfzakndc2czafy3hp1f69x-initrd-linux-6.9-initrd.efi
    init=/nix/store/ymq2z16ni6wdsb8nw4762js4imp60pb6-nixos-system-rose-25.05.20250930.51fcc5b/init
...
Memory:
  System RAM: total: 2 TiB available: 1.96 TiB used: 1.51 TiB (77.3%)
...
CPU:
  ...
  Speed (MHz): avg: 1500 min/max: 1500/3631 boost: enabled base/boost: 2650/3625 scaling:
    ...
    94: 1500 95: 1500 96: 1500 bogomips: 508795
...
Network:
  Device-1: Broadcom BCM57412 NetXtreme-E 10Gb RDMA Ethernet driver: bnxt_en v: kernel pcie: gen: 3
    speed: 8 GT/s lanes: 8 port: N/A bus-ID: a1:00.0 chip-ID: 14e4:16d6 class-ID: 0200 temp: 54.0 C
  ...
  IF-ID-1: docker0 state: down mac: 02:42:78:d0:13:a5
...
RAID:
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 684 GiB
    allocated: 1.07 TiB zfs-fs: size: 1.68 TiB free: 629.2 GiB
  Components: Online:
  1: nvme1n1p2 maj-min: 259:3 size: 1.75 TiB
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.43 TiB used: 1021.87 GiB (29.1%)
  ID-1: /dev/nvme0n1 maj-min: 259:0 vendor: Samsung model: MZQL21T9HCJR-00A07 size: 1.75 TiB
    ...
    serial: S64GNA0T724986 fw-rev: GDC5602Q temp: 33.9 C scheme: GPT
  SMART: yes health: PASSED on: 2y 92d 0h cycles: 85 read-units: 14,642,117 [7.49 TB]
  ...
  SMART: yes health: PASSED on: 2y 92d 0h cycles: 85 read-units: 125,528,607 [64.2 TB]
    written-units: 142,341,357 [72.8 TB]
Partition:
  ID-1: / raw-size: N/A size: 1.61 TiB used: 1021.83 GiB (61.9%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 30 MiB (2.9%) fs: vfat
    block-size: 512 B dev: /dev/nvme1n1p1 maj-min: 259:2
  ID-3: /home raw-size: N/A size: 3.43 TiB used: 1.61 TiB (47.0%) fs: nfs4
    remote: nfs:/export/home
  ID-4: /tmp raw-size: N/A size: 629.21 GiB used: 11.5 MiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu-1: 36 C cpu-2: 38 C mobo: 40 C
  ...
  Power: 12v: 12.112 5v: 4.990 3.3v: 3.276 vbat: N/A dimm-p1: 1.189 dimm-p2: 1.193
  Src: lm-sensors System Temperatures: cpu: 37.8 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 1354 Power: uptime: 12d 4h 48m states: freeze,mem suspend: s2idle wakeups: 0
    hibernate: disabled image: 801.55 GiB Init: systemd v: 257 default: graphical tool: systemctl
