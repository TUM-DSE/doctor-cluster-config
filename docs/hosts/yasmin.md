...
```
System:
  Host: yasmin Kernel: 6.12.66 arch: aarch64 bits: 64 compiler: gcc v: 14.3.0
    clocksource: arch_sys_counter
    parameters: BOOT_IMAGE=(hd3,gpt1)//kernels/5p8m94sc5xamq99py9fxg83rmlihvdby-linux-6.12.66-Image
    init=/nix/store/6yxcp75d1h8pdry7y92xjvgd4gls7plw-nixos-system-yasmin-25.11.20260123.ac3d985/init
  ...
  Console: pty pts/4 Distro: NixOS 25.11 (Xantusia)
Machine:
...
Memory:
  System RAM: total: 256 GiB available: 251.2 GiB used: 49.53 GiB (19.7%)
...
Network:
  ...
  IF-ID-1: docker0 state: down mac: b6:f5:fe:34:fd:f7
...
RAID:
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 888 GiB free: 303 GiB
    allocated: 585 GiB zfs-fs: size: 860.5 GiB free: 274.96 GiB
  Components: Online:
  1: sdb2 maj-min: 8:18 size: 893.76 GiB
Drives:
  Local Storage: total: raw: 1.78 TiB usable: 1.75 TiB used: 638.65 GiB (35.6%)
  ...
  SMART: yes health: PASSED on: 68d 21h cycles: 11 read-units: 9,175 [4.69 GB]
    written-units: 969,305 [496 GB]
  ...
  SMART: yes state: enabled health: PASSED on: 4y 240d 3h cycles: 26 read: 45.19 TiB
    written: 114.57 TiB
Partition:
  ID-1: / raw-size: N/A size: 560.08 GiB used: 285.12 GiB (50.9%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 500 MiB size: 499.7 MiB (99.95%) used: 88.5 MiB (17.7%) fs: vfat
    block-size: 512 B dev: /dev/sdb1 maj-min: 8:17
  ID-3: /home raw-size: N/A size: 3.47 TiB used: 2.54 TiB (73.3%) fs: nfs4
    remote: nfs:/export/home
  ID-4: /tmp raw-size: N/A size: 274.96 GiB used: 384 KiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu-1: 42 C cpu-2: 40 C mobo: 28 C
  Fan Speeds (rpm): N/A
...
Info:
  Processes: 2289 Power: uptime: 56d 1h 21m states: freeze,mem suspend: deep avail: s2idle
    wakeups: 0 hibernate: disabled image: 100.46 GiB Init: systemd v: 258 default: multi-user
    tool: systemctl
  Packages: pm: nix-default pkgs: 0 pm: nix-sys pkgs: 610 libs: 132 pm: nix-usr pkgs: 0
