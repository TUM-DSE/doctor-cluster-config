...
```
System:
  Host: yasmin Kernel: 6.16.9 arch: aarch64 bits: 64 compiler: gcc v: 14.3.0
    clocksource: arch_sys_counter
    parameters: BOOT_IMAGE=(hd3,gpt1)//kernels/9qiwhv8amvi5l647sjdlidri8qgffixd-linux-6.16.9-Image
    init=/nix/store/9ibxxk4jd4m05hw9myvkxmayxrvn732l-nixos-system-yasmin-25.05.20250930.51fcc5b/init
    console=ttyS0,115200 console=ttyAMA0,115200 console=tty0 console=ttyS0,115200n8
    console=ttyAMA0,115200n8 console=tty0 nohibernate loglevel=4 lsm=landlock,yama,bpf
...
Memory:
  System RAM: total: 256 GiB available: 251.21 GiB used: 22.63 GiB (9.0%)
...
CPU:
  ...
  Topology: cpus: 2x clusters: 28 cores: 28 threads: 112 tpc: 4 smt: enabled cache:
    L1: 2x 1.8 MiB (3.5 MiB) desc: d-28x32 KiB; i-28x32 KiB L2: 2x 7 MiB (14 MiB) desc: 28x256 KiB
    L3: 2x 32 MiB (64 MiB) desc: 1x32 MiB
...
Network:
  ...
  IF-ID-1: docker0 state: up speed: 10000 Mbps duplex: unknown mac: 02:42:eb:61:86:3e
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IP v6: fe80::42:ebff:fe61:863e/64 virtual: proto kernel_ll scope: link
  ...
  IF-ID-4: veth3b77beb state: up speed: 10000 Mbps duplex: full mac: de:10:bd:6e:ff:f1
  Info: services: sshd, systemd-networkd, systemd-timesyncd
  WAN IP: 131.159.102.7
RAID:
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 888 GiB free: 200 GiB
    allocated: 688 GiB zfs-fs: size: 860.5 GiB free: 171.53 GiB
  Components: Online:
  1: sdb2 maj-min: 8:18 size: 893.76 GiB
Drives:
  Local Storage: total: raw: 1.78 TiB usable: 1.75 TiB used: 715.6 GiB (39.9%)
  ID-1: /dev/nvme0n1 maj-min: 259:0 vendor: Samsung model: SSD 970 EVO Plus 1TB size: 931.51 GiB
    ...
    serial: S4EWNX0R514087T fw-rev: 2B2QEXM7 temp: 33.9 C
  SMART: yes health: PASSED on: 68d 19h cycles: 11 read-units: 1,247 [638 MB]
    written-units: 562,593 [288 GB]
  ID-2: /dev/sdb maj-min: 8:16 vendor: Samsung model: MZ7LH960HAJR-00005 family: based SSDs
    ...
    serial: S45NNC0R216725 fw-rev: 904Q temp: 24 C scheme: GPT
  SMART: yes state: enabled health: PASSED on: 4y 88d 9h cycles: 26 read: 41.47 TiB
    written: 110.4 TiB
Partition:
  ID-1: / raw-size: N/A size: 620.63 GiB used: 449.1 GiB (72.4%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 500 MiB size: 499.7 MiB (99.95%) used: 93.2 MiB (18.6%) fs: vfat
    block-size: 512 B dev: /dev/sdb1 maj-min: 8:17
  ID-3: /home raw-size: N/A size: 3.43 TiB used: 1.61 TiB (47.0%) fs: nfs4
    remote: nfs:/export/home
  ID-4: /tmp raw-size: N/A size: 171.53 GiB used: 512 KiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu-1: 41 C cpu-2: 40 C mobo: 28 C
  Fan Speeds (rpm): N/A
...
Info:
  Processes: 2239 Power: uptime: 3d 15h 44m states: freeze,mem suspend: deep avail: s2idle
    wakeups: 0 hibernate: disabled image: 100.46 GiB Init: systemd v: 257 default: multi-user
    tool: systemctl
  Packages: pm: nix-default pkgs: 0 pm: nix-sys pkgs: 573 libs: 130 pm: nix-usr pkgs: 0
