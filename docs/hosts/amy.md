...
System:
  Host: amy Kernel: 6.9.0-rc7 arch: x86_64 bits: 64 compiler: gcc v: 13.3.0 clocksource: tsc
    ...
    init=/nix/store/7xvi52j1vx3sh85fd4f7n5hirhx7fyyg-nixos-system-amy-24.11.20250209.392aa11/init
...
Memory:
  System RAM: total: 2 TiB available: 1.95 TiB used: 1.5 TiB (77.0%)
...
CPU:
  ...
  Speed (MHz): avg: 1523 high: 2650 min/max: 1500/3631 boost: disabled base/boost: 2650/3625
    ...
    2: 1500 3: 2650 4: 1500 5: 1500 6: 1500 7: 1500 8: 1500 9: 1500 10: 1500 11: 1500 12: 1500
    ...
    43: 1500 44: 1500 45: 1500 46: 1500 47: 1500 48: 1500 bogomips: 254392
...
Network:
  Device-1: Intel Ethernet E810-C for QSFP driver: ice v: kernel pcie: gen: 4 speed: 16 GT/s
    lanes: 16 port: N/A bus-ID: 61:00.0 chip-ID: 8086:1592 class-ID: 0200 temp: 56.0 C
  ...
  IF-ID-1: br-0c031003423a state: down mac: 02:42:6b:fd:8f:1a
  IP v4: 172.18.0.1/16 scope: global broadcast: 172.18.255.255
  IF-ID-2: bra-okelmann0 state: down mac: 3e:8d:c0:4e:8d:82
  IP v4: 192.168.56.1/21 scope: global
  IP v6: fe80::3c8d:c0ff:fe4e:8d82/64 virtual: proto kernel_ll scope: link
  IF-ID-3: docker0 state: down mac: 02:42:84:40:6d:52
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IF-ID-4: doctor-bridge state: up speed: 10000 Mbps duplex: unknown mac: 84:16:0c:cd:99:10
  ...
  IF-ID-6: tap-okelmann state: down mac: aa:d3:29:47:68:03
  IP v6: fe80::a8d3:29ff:fe47:6803/64 virtual: proto kernel_ll scope: link
  IF-ID-7: tapa-okelmann0 state: down mac: a6:1d:c3:29:80:aa
  IP v6: fe80::a41d:c3ff:fe29:80aa/64 virtual: proto kernel_ll scope: link
...
RAID:
  Device-1: zokelmannvms type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 1.23 TiB
    allocated: 518 GiB zfs-fs: size: 1.68 TiB free: 1.17 TiB
  Components: Online:
  1: nvme1n1p1 maj-min: 259:1 size: 1.75 TiB
  Device-2: zroot type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 1.06 TiB
    allocated: 691 GiB zfs-fs: size: 1.68 TiB free: 1.01 TiB
  Components: Online:
  1: nvme0n1p2 maj-min: 259:4 size: 1.75 TiB
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.36 TiB used: 1 TiB (29.8%)
  ID-1: /dev/nvme0n1 maj-min: 259:2 vendor: Samsung model: MZQL21T9HCJR-00A07 size: 1.75 TiB
    block-size: physical: 4096 B logical: 512 B speed: 63.2 Gb/s lanes: 4 tech: SSD
    serial: S64GNA0T724989 fw-rev: GDC5602Q temp: 39.9 C scheme: GPT
  SMART: yes health: PASSED on: 2y 3d 19h cycles: 135 read-units: 70,819,421 [36.2 TB]
    written-units: 117,128,356 [59.9 TB]
  ID-2: /dev/nvme1n1 maj-min: 259:0 vendor: Samsung model: MZQL21T9HCJR-00A07 size: 1.75 TiB
    block-size: physical: 4096 B logical: 512 B speed: 63.2 Gb/s lanes: 4 tech: SSD
    serial: S64GNA0T724990 fw-rev: GDC5602Q temp: 40.9 C scheme: MBR
  SMART: yes health: PASSED on: 2y 3d 20h cycles: 135 read-units: 28,445,194 [14.5 TB]
    written-units: 53,625,106 [27.4 TB]
Partition:
  ID-1: / raw-size: N/A size: 1.5 TiB used: 507.33 GiB (33.0%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 57.9 MiB (5.7%) fs: vfat
    block-size: 512 B dev: /dev/nvme0n1p1 maj-min: 259:3
  ID-3: /home raw-size: N/A size: 2.72 TiB used: 1.86 TiB (68.7%) fs: nfs4
    remote: nfs:/export/home
  ID-4: /tmp raw-size: N/A size: 1.01 TiB used: 2.4 MiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu-1: 45 C cpu-2: 42 C mobo: 45 C
  Fan Speeds (rpm): fan-1: 3780 fan-2: 3780 fan-3: 3780 fan-4: 3920 fan-5: 3920 fan-6: 3920
    fan-7: 3920 fan-8: 3780 fan-9: 1260 fan-16: 1260
  Power: 12v: 12.112 5v: 5.020 3.3v: 3.276 vbat: N/A dimm-p1: 1.213 dimm-p2: 1.221
  Src: lm-sensors System Temperatures: cpu: 45.1 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 992 Power: uptime: 7h 56m states: freeze,mem suspend: s2idle wakeups: 0
