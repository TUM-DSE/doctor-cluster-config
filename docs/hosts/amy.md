...
```
System:
  Host: amy Kernel: 6.6.56 arch: x86_64 bits: 64 compiler: gcc v: 13.2.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\r6i3zg6d3i8wwwgq4yrr36jbycjvk5hn-initrd-linux-6.6.56-initrd.efi
    init=/nix/store/m5iqlqlcaj8p97pjl2a5l9j3gg5rldk6-nixos-system-amy-24.05.20241013.ed88381/init
...
Graphics:
  ...
  Display: x11 server: X.org v: 1.21.1.13 compositor: xfwm4 driver: gpu: ast tty: 80x40
...
Network:
  ...
  IF-ID-1: br-0c031003423a state: down mac: 02:42:e8:ba:8f:ff
  ...
  IF-ID-3: docker0 state: down mac: 02:42:42:07:0c:cd
  ...
  IF-ID-5: tap-okelmann state: down mac: aa:d3:29:47:68:03
  ...
  IP v6: fe80::986b:6aff:fe9a:d81f/64 virtual: proto kernel_ll scope: link
  ...
  IF-ID-70: tapa-okelmann0 state: down mac: a6:1d:c3:29:80:aa
  IP v6: fe80::a41d:c3ff:fe29:80aa/64 virtual: proto kernel_ll scope: link
  IF-ID-71: tinc.retiolum state: unknown speed: 10000 Mbps duplex: full mac: N/A
...
RAID:
  Device-1: zokelmannvms type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 1.22 TiB
...
Partition:
  ...
  ID-4: /tmp raw-size: N/A size: 1.17 TiB used: 8.7 GiB (0.7%) fs: zfs logical: zroot/root/tmp
Swap:
