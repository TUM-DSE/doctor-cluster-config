...
```
System:
  Host: vislor Kernel: 6.6.0-rc1 arch: x86_64 bits: 64 compiler: gcc v: 13.2.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\my55vvhgailmvss0017qknpzdalb67l4-initrd-linux-6.6-initrd.efi
    init=/nix/store/g16xd4snlpgiklscwb64vcwqlfigymmp-nixos-system-vislor-24.05.20240709.249fbde/init
    console=ttyS0,115200 console=tty0 hugepagesz=1GB hugepages=0 hugepagesz=2MB hugepages=1000
    kvm_amd.sev=1 kvm_amd.sev_es=1 kvm_amd.sev_snp=1 sp5100_tco.blacklist=yes isolcpus=0-31
    nvme.poll_queues=4 nvme_core.multipath=N nohibernate loglevel=4
  Console: pty pts/1 Distro: NixOS 24.05 (Uakari)
Machine:
...
Memory:
  System RAM: total: 768 GiB available: 752.49 GiB used: 11.02 GiB (1.5%)
...
CPU:
  ...
  Speed (MHz): avg: 2699 high: 2700 min/max: N/A base/boost: 2700/4400 volts: 1.8 V
    ext-clock: 32000 MHz cores: 1: 2700 2: 2700 3: 2700 4: 2700 5: 2700 6: 2700 7: 2700 8: 2700
    9: 2700 10: 2700 11: 2700 12: 2700 13: 2700 14: 2700 15: 2700 16: 2700 17: 2700 18: 2700
    19: 2700 20: 2700 21: 2700 22: 2700 23: 2700 24: 2700 25: 2700 26: 2700 27: 2700 28: 2700
    29: 2700 30: 2700 31: 2700 32: 2700 33: 2700 34: 2700 35: 2699 36: 2700 37: 2700 38: 2700
    39: 2700 40: 2700 41: 2700 42: 2700 43: 2700 44: 2691 45: 2700 46: 2700 47: 2700 48: 2700
    49: 2700 50: 2700 51: 2700 52: 2700 53: 2700 54: 2700 55: 2700 56: 2700 57: 2700 58: 2697
...
Network:
  Device-1: Mellanox MT2894 Family [ConnectX-6 Lx] driver: mlx5_core v: kernel pcie: gen: 4
    speed: 16 GT/s lanes: 8 port: N/A bus-ID: 01:00.0 chip-ID: 15b3:101f class-ID: 0200 temp: 52.0 C
  ...
  IF-ID-1: docker0 state: down mac: 02:42:61:9e:09:07
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IF-ID-2: mtap_cvm state: down mac: ce:5b:cd:bf:57:e1
  IF-ID-3: tap_cvm state: down mac: 9a:e1:68:28:ba:69
  ...
  IF-ID-5: virbr_cvm state: down mac: 06:59:2e:a7:b6:ff
...
RAID:
  ...
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 3.48 TiB free: 2.86 TiB
    allocated: 643 GiB zfs-fs: size: 3.38 TiB free: 2.75 TiB
  Components: Online:
  1: nvme0n1p2 maj-min: 259:4 size: 3.49 TiB
Drives:
  Local Storage: total: raw: 6.4 TiB usable: 6.29 TiB used: 503.65 GiB (7.8%)
  ID-1: /dev/nvme0n1 maj-min: 259:2 vendor: Samsung model: MZQL23T8HCLS-00A07 size: 3.49 TiB
    ...
    serial: S64HNS0W800676 fw-rev: GDC5602Q temp: 35.9 C scheme: GPT
  SMART: yes health: PASSED on: 293d 2h cycles: 51 read-units: 33,131,163 [16.9 TB]
    written-units: 45,825,876 [23.4 TB]
  ID-2: /dev/nvme1n1 maj-min: 259:0 vendor: Dell model: Ent NVMe AGN MU AIC 1.6TB size: 1.46 TiB
    ...
    serial: S61ANA0R501120 fw-rev: 2.0.2 temp: 31.9 C
  SMART: yes health: PASSED on: 2y 280d 14h cycles: 64 read-units: 432,300,377 [221 TB]
    written-units: 232,016,113 [118 TB]
  ID-3: /dev/nvme2n1 maj-min: 259:1 vendor: Samsung model: MZPLJ1T6HBJR-00007 size: 1.46 TiB
    block-size: physical: 512 B logical: 512 B speed: 126.4 Gb/s lanes: 8 tech: SSD
    serial: S55JNC0W600234 fw-rev: EPK9GB5Q temp: 41.9 C
  SMART: yes health: PASSED on: 341d 22h cycles: 91 read-units: 314,118,496 [160 TB]
    written-units: 224,440,692 [114 TB]
Partition:
  ID-1: / raw-size: N/A size: 3.24 TiB used: 503.51 GiB (15.2%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 143 MiB (14.0%) fs: vfat
    block-size: 512 B dev: /dev/nvme0n1p1 maj-min: 259:3
  ID-3: /home raw-size: N/A size: 3.02 TiB used: 1.3 TiB (43.1%) fs: nfs remote: nfs:/export/home
  ID-4: /tmp raw-size: N/A size: 2.75 TiB used: 256 KiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu: N/A mobo: N/A
  Fan Speeds (rpm): cpu: 11280 fan-27: 9000 fan-42: 11280 fan-43: 9000 fan-58: 11160 fan-59: 9000
    fan-74: 11160 fan-75: 8880 fan-90: 11160 fan-91: 8880 fan-106: 11280 fan-107: 9000
  Power: 12v: N/A 5v: N/A 3.3v: N/A vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 61.9 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 956 Power: uptime: 0h 7m states: freeze,mem suspend: s2idle wakeups: 0
    hibernate: disabled image: 300.99 GiB Init: systemd v: 255 default: multi-user tool: systemctl
  Packages: pm: nix-default pkgs: 0 pm: nix-sys pkgs: 620 libs: 143 pm: nix-usr pkgs: 0
