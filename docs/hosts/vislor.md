...
```
System:
  Host: vislor Kernel: 6.11.0-svsm-vc-wip arch: x86_64 bits: 64 compiler: gcc v: 14.3.0
    clocksource: tsc avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\3whaif22kvn4wlzf8znrkwwv39dkqlcc-initrd-linux-6.11-vc-initrd.efi
    init=/nix/store/lhnq1hzr5qnsd6s1cch09q2c6wrwbkbr-nixos-system-vislor-25.11.20260109.ccb553d/init
    console=ttyS0,115200 console=tty0 kvm_amd.sev=1 kvm_amd.sev_es=1 kvm_amd.sev_snp=1
    sp5100_tco.blacklist=yes nvme.poll_queues=4 nvme_core.multipath=N amd_iommu=on
    kvm_amd.dump_invalid_vmcb=1 nohibernate loglevel=4 lsm=landlock,yama,bpf
...
Memory:
  System RAM: total: 768 GiB available: 752.48 GiB used: 245.47 GiB (32.6%)
...
CPU:
  ...
  Speed (MHz): avg: 2998 high: 3906 min/max: N/A base/boost: 2700/4400 volts: 1.8 V
    ext-clock: 32000 MHz cores: 1: 3900 2: 2700 3: 2700 4: 3889 5: 2700 6: 2700 7: 2700 8: 2700
    9: 2700 10: 2700 11: 2700 12: 2700 13: 2700 14: 2700 15: 2700 16: 2700 17: 3869 18: 2700
    19: 2700 20: 2700 21: 2700 22: 2700 23: 2700 24: 3906 25: 3900 26: 3882 27: 2700 28: 2700
    29: 2700 30: 3885 31: 2700 32: 2700 33: 3900 34: 2700 35: 2700 36: 2700 37: 2700 38: 2700
    39: 2700 40: 2700 41: 2700 42: 2700 43: 3894 44: 2700 45: 2700 46: 2700 47: 3896 48: 2700
    49: 2700 50: 2700 51: 3890 52: 3890 53: 2700 54: 3897 55: 2700 56: 3898 57: 2700 58: 2700
    59: 3904 60: 2700 61: 2700 62: 2700 63: 3895 64: 2700 bogomips: 345599
...
Network:
  Device-1: Mellanox MT2894 Family [ConnectX-6 Lx] driver: mlx5_core v: kernel pcie: gen: 4
    speed: 16 GT/s lanes: 8 port: N/A bus-ID: 01:00.0 chip-ID: 15b3:101f class-ID: 0200 temp: 48.0 C
  ...
  IF-ID-1: br-11c788e231d8 state: down mac: 1a:02:4d:7b:db:cc
  IP v4: 172.19.0.1/16 scope: global broadcast: 172.19.255.255
  IF-ID-2: docker0 state: down mac: ae:9a:f6:53:92:c2
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IP v6: fe80::ac9a:f6ff:fe53:92c2/64 virtual: proto kernel_ll scope: link
  ...
  IF-ID-4: tap0_masa state: down mac: b6:cf:26:df:35:16
  IP v4: 192.168.21.1/24 scope: global
  IP v6: fe80::b4cf:26ff:fedf:3516/64 virtual: proto kernel_ll scope: link
  IF-ID-5: tap0_patrick state: up speed: 10000 Mbps duplex: full mac: ce:57:9d:06:d5:84
  IP v4: 192.168.27.1/24 scope: global
  IP v6: fe80::cc57:9dff:fe06:d584/64 virtual: proto kernel_ll scope: link
...
RAID:
  ...
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 3.48 TiB free: 2.17 TiB
    allocated: 1.31 TiB zfs-fs: size: 3.38 TiB free: 2.06 TiB
  Components: Online:
  1: nvme0n1p2 maj-min: 259:4 size: 3.49 TiB
Drives:
  Local Storage: total: raw: 9.9 TiB usable: 9.78 TiB used: 1.05 TiB (10.7%)
  ...
  SMART: yes health: PASSED on: 2y 169d 21h cycles: 87 read-units: 66,778,760 [34.1 TB]
    written-units: 108,022,523 [55.3 TB]
  ...
  SMART: yes health: PASSED on: 2y 218d 17h cycles: 127 read-units: 314,119,676 [160 TB]
  ...
  SMART: yes health: PASSED on: 4y 157d 9h cycles: 100 read-units: 460,386,146 [235 TB]
    written-units: 255,968,012 [131 TB]
  ID-4: /dev/nvme3n1 maj-min: 259:5 vendor: Samsung model: MZQL23T8HCLS-00A07 size: 3.49 TiB
    block-size: physical: 4096 B logical: 512 B speed: 63.2 Gb/s lanes: 4 tech: SSD
    serial: S64HNJ0X815789 fw-rev: GDC5A02Q temp: 29.9 C
  SMART: yes health: PASSED on: 203d 0h cycles: 30 read-units: 154,213,426 [78.9 TB]
    written-units: 179,723,587 [92.0 TB]
Partition:
  ID-1: / raw-size: N/A size: 3.11 TiB used: 1.05 TiB (33.7%) fs: zfs logical: zroot/root/nixos
  ...
  ID-4: /tmp raw-size: N/A size: 2.06 TiB used: 109 MiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu: N/A mobo: N/A
  Fan Speeds (rpm): cpu: 8760 fan-27: 6960 fan-42: 8760 fan-43: 6960 fan-58: 8760 fan-59: 6960
    fan-74: 8760 fan-75: 6840 fan-90: 8760 fan-91: 6960 fan-106: 8760 fan-107: 6960
  Power: 12v: N/A 5v: N/A 3.3v: N/A vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 57.4 C mobo: 47.0 C
  Fan Speeds (rpm): N/A
Info:
  Processes: 1117 Power: uptime: 27d 22h 1m states: freeze,mem suspend: s2idle wakeups: 0
    hibernate: disabled image: 300.98 GiB Init: systemd v: 258 default: multi-user tool: systemctl
  Packages: 823 pm: nix-default pkgs: 44 pm: nix-sys pkgs: 735 libs: 161 pm: nix-usr pkgs: 44
    libs: 7 Compilers: gcc: 14.3.0 Client: Sudo v: 1.9.17p2 inxi: 3.3.39
```
