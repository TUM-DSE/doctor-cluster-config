...
```
System:
  Host: wilfred Kernel: 6.8.12 arch: x86_64 bits: 64 compiler: gcc v: 13.2.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\klhdprnw6mcapjc6ccyviksxcbr9b2j6-initrd-linux-6.8.12-initrd.efi
    init=/nix/store/b2mrkq4h9vznyfc66iaxli8jy0vavci2-nixos-system-wilfred-24.05.20240709.249fbde/init
...
Machine:
  ...
  Mobo: Supermicro model: X12SPW-TF v: 2.00 serial: OM21AS002397
    ...
    date: 11/08/2021
Memory:
  System RAM: total: 1.25 TiB available: 251.2 GiB used: 23.58 GiB (9.4%)
...
CPU:
  ...
  Speed (MHz): avg: 1000 high: 3600 min/max: 800/3600 base/boost: 3000/4500 scaling:
    driver: intel_cpufreq governor: schedutil volts: 1.6 V ext-clock: 100 MHz cores: 1: 801 2: 800
    3: 800 4: 1300 5: 3600 6: 800 7: 800 8: 800 9: 800 10: 800 11: 800 12: 800 13: 800 14: 800
    15: 800 16: 800 17: 800 18: 800 19: 800 20: 2300 21: 800 22: 800 23: 800 24: 800
    bogomips: 144000
...
Network:
  ...
  IF-ID-1: docker0 state: down mac: 02:42:c7:48:23:69
...
RAID:
  ...
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 1.3 TiB
    allocated: 445 GiB zfs-fs: size: 1.68 TiB free: 1.23 TiB
  Components: Online:
  1: sda2 maj-min: 8:2 size: 1.75 TiB
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.43 TiB used: 436.21 GiB (12.4%)
  ...
  SMART: yes state: enabled
Partition:
  ID-1: / raw-size: N/A size: 1.65 TiB used: 436.17 GiB (25.8%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 36.5 MiB (3.6%) fs: vfat
...
Sensors:
  Src: ipmi System Temperatures: cpu: 39 C mobo: 31 C
  Fan Speeds (rpm): cpu: 10360 fan-2: 10360 fan-3: 10500 fan-4: 10360 fan-5: 10500 fan-6: 10360
  Power: 12v: 11.590 5v: 5.040 3.3v: 3.322 vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 35.0 C pch: 46.0 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 476 Power: uptime: 2d 23h 38m states: freeze,mem suspend: s2idle wakeups: 0
