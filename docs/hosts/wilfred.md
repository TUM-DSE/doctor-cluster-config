...
```
System:    Host: wilfred Kernel: 6.1.29 x86_64 bits: 64 compiler: gcc v: 11.3.0 
           parameters: initrd=\efi\nixos\sdzrcvlp23r0gbdfwscl431zwfshwmk3-initrd-linux-6.1.29-initrd.efi 
           init=/nix/store/nlrk5fn99iv4543ljb1qanddqp5dmdm7-nixos-system-wilfred-22.11.20230523.fc06fd7/init 
...
Memory:    RAM: total: 251.21 GiB used: 83.56 GiB (33.3%) 
...
CPU:       Info: 12-Core model: Intel Xeon Gold 5317 socket: LGA4189 bits: 64 type: MT MCP 
           ...
           ext-clock: 100 MHz Core speeds (MHz): 1: 3600 2: 3585 3: 3489 4: 3500 5: 3600 6: 3514 
           7: 3600 8: 3500 9: 3600 10: 3525 11: 3600 12: 3600 13: 3600 14: 3600 15: 3600 16: 3231 
           17: 3600 18: 3600 19: 2957 20: 3600 21: 3571 22: 3600 23: 3520 24: 3600 
...
Network:   Device-1: Intel Ethernet X550 vendor: Super Micro driver: ixgbe v: kernel port: 0780 
           ...
           IP v4: 192.168.1.104/24 type: dynamic scope: global 
           IP v6: fe80::b696:91ff:feb3:8b04/64 scope: link 
           IF-ID-1: docker0 state: down mac: 02:42:70:5e:2a:6e 
...
Drives:    Local Storage: total: 3.49 TiB used: 1.76 TiB (50.3%) 
           ...
           temp: 27 C 
           SMART: yes state: enabled 
Partition: ID-1: / raw-size: N/A size: 1.66 TiB used: 378.34 GiB (22.3%) fs: zfs 
...
Info:      Processes: 452 
           Uptime: 15:02:06  up 1 day  0:05,  29 users,  load average: 1.17, 1.12, 1.15 wakeups: 0 
           Init: systemd v: 251 target: multi-user.target tool: systemctl Compilers: gcc: 11.3.0 
           clang: 11.1.0 Packages: nix-default: 0 nix-sys: 538 lib: 122 nix-usr: 0 Client: Sudo 
