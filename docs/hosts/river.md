...
```
System:
  Host: river Kernel: 6.12.66 arch: x86_64 bits: 64 compiler: gcc v: 14.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\039fyl3bgnsmwbzn4b14ni44x7z91fv8-initrd-linux-6.12.66-initrd.efi
    init=/nix/store/4zlhm31ffbca8968l57irs3fziwsx2kw-nixos-system-river-25.11.20260123.ac3d985/init
    intel_iommu=on console=ttyS1,115200n8 console=tty1 console=ttyS0,115200 console=tty0
    hugepagesz=1GB hugepages=8 hugepagesz=2MB hugepages=51200 isolcpus=22,23 nohz_full=22,23
    rcu_nocbs=22,23 nohibernate loglevel=4 lsm=landlock,yama,bpf
...
Machine:
  ...
  Mobo: Supermicro model: X12SPW-TF v: 2.00 serial: OM21AS002408
    ...
    date: 11/08/2021
Memory:
  System RAM: total: 1.25 TiB available: 251.19 GiB used: 112.92 GiB (45.0%)
...
Network:
  ...
  IP v6: fe80::3eec:efff:fe62:ac56/64 virtual: proto kernel_ll scope: link
  ...
  IP v6: fe80::3eec:efff:fe62:ac57/64 virtual: proto kernel_ll scope: link
  ...
  IP v6: fe80::21b:21ff:fec3:82d8/64 virtual: proto kernel_ll scope: link
  ...
  IF-ID-1: docker0 state: down mac: 7a:91:13:14:50:3d
...
RAID:
  ...
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 1.66 TiB
    allocated: 81.2 GiB zfs-fs: size: 1.68 TiB free: 1.6 TiB
  Components: Online:
  1: sdb2 maj-min: 8:18 size: 1.75 TiB
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.43 TiB used: 81.14 GiB (2.3%)
  ...
  SMART: yes state: enabled
Partition:
  ID-1: / raw-size: N/A size: 1.68 TiB used: 81.1 GiB (4.7%) fs: zfs logical: zroot/root/nixos
...
Sensors:
  Src: ipmi System Temperatures: cpu: 36 C mobo: 25 C
  Fan Speeds (rpm): cpu: 7140 fan-2: 7000 fan-3: 7000 fan-4: 7140 fan-5: 7140 fan-6: 7000
  Power: 12v: 11.508 5v: 4.958 3.3v: 3.299 vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 31.0 C pch: 44.0 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 475 Power: uptime: 1h 21m states: freeze,mem suspend: s2idle wakeups: 0
