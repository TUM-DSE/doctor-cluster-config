...
```
System:    Host: jackson Kernel: 6.1.29 x86_64 bits: 64 compiler: gcc v: 11.3.0 
           parameters: initrd=\efi\nixos\blnyq6l3vfl2bqvz281r4ycxqbw6ccix-initrd-linux-6.1.29-initrd.efi 
           init=/nix/store/406kdb8mf7p2y2jd1xwg9a67f3f84bk8-nixos-system-jackson-22.11.20230523.fc06fd7/init 
...
Memory:    RAM: total: 251.21 GiB used: 67.78 GiB (27.0%) 
...
CPU:       Info: 12-Core model: Intel Xeon Gold 5317 socket: LGA4189 bits: 64 type: MT MCP 
           ...
           ext-clock: 100 MHz Core speeds (MHz): 1: 3600 2: 3600 3: 1330 4: 3600 5: 3600 6: 3600 
           7: 3600 8: 3600 9: 3600 10: 1807 11: 3600 12: 3600 13: 3600 14: 3600 15: 3600 16: 3600 
           17: 3600 18: 3265 19: 3600 20: 3600 21: 3600 22: 3600 23: 3600 24: 2022 
...
Network:   Device-1: Intel Ethernet X550 vendor: Super Micro driver: ixgbe v: kernel port: 0780 
           ...
           IP v4: 131.159.102.3/24 type: dynamic scope: global broadcast: 131.159.102.255 
           ...
           IP v4: 169.254.233.41/16 scope: link 
           ...
           IF: enp81s0f1 state: up speed: 100000 Mbps duplex: full mac: b4:96:91:a4:1b:89 
           IP v4: 192.168.1.11/24 scope: global broadcast: 192.168.1.255 
           IP v6: fe80::b696:91ff:fea4:1b89/64 scope: link 
           IF-ID-1: docker0 state: up speed: 10000 Mbps duplex: unknown mac: 02:42:91:7f:68:18 
           IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255 
           IP v6: fe80::42:91ff:fe7f:6818/64 scope: link 
           IF-ID-2: docker_gwbridge state: down mac: 02:42:92:c6:62:14 
           ...
           IF-ID-5: veth5179390 state: up speed: 10000 Mbps duplex: full mac: 12:8c:79:6f:ec:6a 
...
Drives:    Local Storage: total: raw: 3.49 TiB usable: 5.22 TiB used: 1.51 TiB (29.0%) 
           ...
           SMART: yes state: enabled 
Partition: ID-1: / raw-size: N/A size: 1.67 TiB used: 121.65 GiB (7.1%) fs: zfs 
...
Info:      Processes: 416 
           Uptime: 15:02:06  up 12 days 14:55,  0 users,  load average: 0.12, 0.15, 0.15 
           wakeups: 0 Init: systemd v: 251 target: multi-user.target tool: systemctl Compilers: 
           gcc: 11.3.0 Packages: nix-default: 0 nix-sys: 383 lib: 61 nix-usr: 0 Client: Sudo 
