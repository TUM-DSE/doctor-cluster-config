...
```
System:    Host: jackson Kernel: 6.0.19 x86_64 bits: 64 compiler: gcc v: 11.3.0 
           parameters: initrd=\efi\nixos\5dyy3szwk4s5bjwhkiwdwy9kic8ldncj-initrd-linux-6.0.19-initrd.efi 
           init=/nix/store/jf4dkfxrkv6gw221c8000ivj91bq7jfm-nixos-system-jackson-22.11.20230120.aaa0f4f/init 
           console=ttyS1,115200n8 console=tty1 console=tty0 console=ttyS0,115200 nohibernate 
           loglevel=4 
...
Memory:    RAM: total: 251.21 GiB used: 15.11 GiB (6.0%) 
...
CPU:       Info: 12-Core model: Intel Xeon Gold 5317 socket: LGA4189 bits: 64 type: MT MCP 
           ...
           7: 3600 8: 3600 9: 3600 10: 3600 11: 3600 12: 3600 13: 1074 14: 3600 15: 3600 16: 3600 
           17: 3600 18: 3150 19: 3600 20: 3600 21: 3600 22: 3600 23: 3600 24: 3600 
...
Network:   Device-1: Intel Ethernet X550 vendor: Super Micro driver: ixgbe v: kernel port: 0780 
           ...
           IF-ID-1: docker0 state: down mac: 02:42:2e:ef:ad:fe 
           IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255 
           IF-ID-2: docker_gwbridge state: down mac: 02:42:00:23:a3:c0 
...
Drives:    Local Storage: total: raw: 3.49 TiB usable: 5.22 TiB used: 1.09 TiB (20.9%) 
           ...
           temp: 29 C 
           SMART: yes state: enabled 
Partition: ID-1: / raw-size: N/A size: 1.68 TiB used: 39.52 GiB (2.3%) fs: zfs 
...
Info:      Processes: 398 
           Uptime: 14:25:37  up 16 days 14:17,  0 users,  load average: 0.15, 0.12, 0.17 
           wakeups: 0 Init: systemd v: 251 target: multi-user.target tool: systemctl Compilers: 
           gcc: 11.3.0 Packages: nix-default: 0 nix-sys: 427 lib: 63 nix-usr: 0 Client: Sudo 
