...
```
System:    Host: dan Kernel: 5.15.56 x86_64 bits: 64 compiler: gcc v: 11.3.0 Console: N/A 
...
Machine:   Type: Server System: Dell product: PowerEdge R440 v: N/A serial: 4YBVXK3 Chassis: 
           ...
           date: 07/09/2021 
Memory:    RAM: total: 125.53 GiB used: 5.5 GiB (4.4%) 
...
CPU:       Info: 2x 10-Core model: Intel Xeon Gold 5215 bits: 64 type: MT MCP SMP 
           ...
           flags: avx avx2 lm nx pae sse sse2 sse3 sse4_1 sse4_2 ssse3 vmx bogomips: 200118 
...
Network:   Device-1: Broadcom NetXtreme BCM5720 Gigabit Ethernet PCIe vendor: Dell driver: tg3 
           ...
           IF-ID-1: cni0 state: up speed: 10000 Mbps duplex: unknown mac: 4e:2b:fb:e3:60:95 
           IP v4: 10.42.3.1/24 scope: global broadcast: 10.42.3.255 
           IP v6: fe80::4c2b:fbff:fee3:6095/64 scope: link 
           IF-ID-2: docker0 state: down mac: 02:42:24:c0:88:ed 
           ...
           IP v6: fe80::3359:e467:51c8:c259/64 virtual: stable-privacy scope: link 
           IF-ID-4: veth59a8acca state: up speed: 10000 Mbps duplex: full mac: 8a:05:1d:61:a7:ef 
           IF-ID-5: vethaedc571a state: up speed: 10000 Mbps duplex: full mac: 76:90:bf:2c:64:e4 
           IF-ID-6: vethcccfc492 state: up speed: 10000 Mbps duplex: full mac: 66:85:4b:e9:95:4e 
...
Drives:    Local Storage: total: raw: 1.46 TiB usable: 2.91 TiB used: 315.33 GiB (10.6%) 
           ...
           scheme: GPT 
Partition: ID-1: / size: 1.4 TiB used: 11.92 GiB (0.8%) fs: zfs logical: zroot/root/nixos 
...
Info:      Processes: 587 Uptime: 1h 21m wakeups: 0 Init: systemd v: 250 target: multi-user.target 
