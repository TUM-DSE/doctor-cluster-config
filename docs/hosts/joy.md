...
Memory:
  System RAM: total: 64 GiB note: est. available: 61.3 GiB used: 2.28 GiB (3.7%)
...
CPU:
  Info: model: ARMv8 v8l variant: armv8 bits: 64 type: MCP SMP arch: v8l family: 8 model-id: 0
    stepping: 1
  Topology: cpus: 2x cores: 4 smt: <unsupported> cache: L1: 2x 512 KiB (1024 KiB)
    desc: d-4x64 KiB; i-4x64 KiB L2: 2x 1024 KiB (2 MiB) desc: 4x256 KiB L3: 2x 2 MiB (4 MiB)
    desc: 1x2 MiB
  Speed (MHz): avg: 1075 high: 1421 min/max: 115/2202 base/boost: 2000/2000 scaling:
    driver: tegra194 governor: schedutil ext-clock: 31 MHz cores: 1: 730 2: 730 3: 730 4: 730 5: 1421
    6: 1421 7: 1421 8: 1421 bogomips: 500
...
Drives:
  ...
  SMART: yes health: PASSED on: 56d 16h cycles: 3,227 read-units: 164,938,588 [84.4 TB]
    written-units: 87,188,767 [44.6 TB]
Partition:
  ...
  ID-4: /tmp raw-size: N/A size: 1.37 TiB used: 1.4 MiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
...
Sensors:
  ...
  Fan Speeds (rpm): N/A
Info:
  Processes: 390 Power: uptime: 214d 19h 59m states: freeze,mem suspend: deep avail: s2idle
