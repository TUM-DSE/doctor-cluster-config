...
```
System:    Host: nardole Kernel: 6.0.19 x86_64 bits: 64 compiler: gcc v: 11.3.0 
           parameters: initrd=\efi\nixos\z85bdpv7nyy43vc6g98760bdj0q2m5lj-initrd-linux-6.0.19-initrd.efi 
           init=/nix/store/asjn7a58p5mszqnhqw0fsc6bixcksawg-nixos-system-nardole-22.11.20230120.aaa0f4f/init 
...
Memory:    RAM: total: 125.69 GiB used: 91.17 GiB (72.5%) 
...
CPU:       Info: 10-Core model: Intel Core i9-10900K bits: 64 type: MT MCP arch: Comet Lake 
           ...
           Speed: 1388 MHz min/max: 800/5300 MHz base/boost: 3600/3700 volts: 1.0 V 
           ext-clock: 100 MHz Core speeds (MHz): 1: 1388 2: 5097 3: 3700 4: 3700 5: 3700 6: 3700 
           7: 3700 8: 3700 9: 800 10: 4087 11: 3700 12: 3700 13: 3700 14: 3700 15: 3700 16: 3700 
...
Network:   Device-1: Intel Ethernet I219-LM vendor: Super Micro driver: e1000e v: kernel 
           ...
           IF-ID-3: docker0 state: down mac: 02:42:7f:66:4a:11 
...
RAID:      Device-1: zpool1 type: zfs status: ONLINE level: linear size: 928 GiB free: 361 GiB 
           allocated: 567 GiB 
           Components: Online: N/A 
           Device-2: zpool2 type: zfs status: ONLINE level: linear size: 14.5 TiB free: 14 TiB 
           allocated: 579 GiB 
           Components: Online: N/A 
           Device-3: zroot type: zfs status: ONLINE level: linear size: 888 GiB free: 669 GiB 
           allocated: 219 GiB 
           Components: Online: N/A 
Drives:    Local Storage: total: raw: 23.62 TiB usable: 39.89 TiB used: 1.14 TiB (2.9%) 
           ...
           rotation: SSD serial: S4EWNX0R410276D rev: 2B2QEXM7 temp: 26 Celsius C scheme: GPT 
           SMART: yes health: PASSED on: 51d 11h cycles: 3 read-units: 52,969,380 [27.1 TB] 
           written-units: 15,172,544 [7.76 TB] 
           ...
           scheme: GPT 
           SMART: yes state: enabled health: PASSED on: 1y 339d 16h cycles: 42 read: 15.75 TiB 
           written: 28.17 TiB 
           ...
           SMART: yes state: enabled health: PASSED on: 1y 96d 1h cycles: 1 
Partition: ID-1: / raw-size: N/A size: 730.44 GiB used: 89.91 GiB (12.3%) fs: zfs 
           logical: zroot/root/nixos 
           ID-2: /boot raw-size: 500 MiB size: 499.7 MiB (99.95%) used: 27.4 MiB (5.5%) fs: vfat 
           block-size: 512 B dev: /dev/sda1 maj-min: 8:1 
           ID-3: /tmp raw-size: N/A size: 640.6 GiB used: 74.9 MiB (0.0%) fs: zfs 
...
Info:      Processes: 562 
           Uptime: 14:25:37  up 16 days 14:19,  0 users,  load average: 0.00, 0.00, 0.00 
           wakeups: 0 Init: systemd v: 251 target: multi-user.target tool: systemctl Compilers: 
           gcc: 11.3.0 Packages: nix-default: 0 nix-sys: 443 lib: 63 nix-usr: 0 Client: Sudo 
