...
```
System:    Host: nardole Kernel: 6.5.7 x86_64 bits: 64 compiler: gcc v: 12.2.0 
           parameters: init=/nix/store/qc9kmpimb9i6dd8z6x1glh3yymnnb989-nixos-system-nardole-23.05.20231015.85ddd23/init 
...
Memory:    RAM: total: 125.69 GiB used: 9.49 GiB (7.5%) 
...
CPU:       Info: 10-Core model: Intel Core i9-10900K bits: 64 type: MT MCP arch: Comet Lake 
           ...
           8: 4995 9: 800 10: 800 11: 800 12: 800 13: 800 14: 800 15: 5102 16: 800 17: 800 18: 800 
           19: 5099 20: 5070 
...
Network:   Device-1: Intel Ethernet I219-LM vendor: Super Micro driver: e1000e v: kernel 
           ...
           IF-ID-3: docker0 state: down mac: 02:42:fa:44:29:d1 
...
RAID:      Device-1: zpool1 type: zfs status: ONLINE level: linear size: 3.48 TiB free: 2.61 TiB 
           ...
           allocated: 157 GiB 
           Components: Online: N/A 
Drives:    Local Storage: total: raw: 26.2 TiB usable: 45.05 TiB used: 932 GiB (2.0%) 
           ...
           rotation: SSD serial: S667NE0W503478 rev: GDC7302Q temp: 39 ° (312 K) C scheme: GPT 
           SMART: yes health: PASSED on: 80d 21h cycles: 2 read-units: 18,745,164 [9.59 TB] 
           written-units: 2,531,505 [1.29 TB] 
           ...
           scheme: GPT 
           SMART: yes state: enabled health: PASSED on: 2y 222d 15h cycles: 45 read: 20.06 TiB 
           written: 33.11 TiB 
           ...
           SMART: yes state: enabled health: PASSED on: 1y 343d 23h cycles: 4 
           ...
           SMART: yes state: enabled health: PASSED on: 1y 343d 23h cycles: 4 
Partition: ID-1: / raw-size: N/A size: 852.06 GiB used: 149.14 GiB (17.5%) fs: zfs 
           logical: zroot/root/nixos 
           ID-2: /boot raw-size: 500 MiB size: 499.7 MiB (99.95%) used: 56.3 MiB (11.3%) fs: vfat 
           block-size: 512 B dev: /dev/sda1 maj-min: 8:1 
           ID-3: /tmp raw-size: N/A size: 702.92 GiB used: 1.1 MiB (0.0%) fs: zfs 
...
Info:      Processes: 627 
           Uptime: 13:02:20  up 4 days 22:13,  0 users,  load average: 0.16, 0.03, 0.01 wakeups: 0 
