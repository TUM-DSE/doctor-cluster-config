...
```
System:
  Host: graham Kernel: 6.6.52 arch: x86_64 bits: 64 compiler: gcc v: 13.2.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\cqyp8p7dfyp7qna9vprrfmr1sji7bva6-initrd-linux-6.6.52-initrd.efi
...
Network:
  ...
  IP v4: 192.168.100.20/24 scope: global
  IP v6: fe80::b696:91ff:fea4:1cf1/64 virtual: proto kernel_ll scope: link
  ...
  IF-ID-1: br-33389a0306b4 state: down mac: 02:42:5d:a8:78:20
  IP v4: 172.18.0.1/16 scope: global broadcast: 172.18.255.255
  IF-ID-2: docker0 state: up speed: 10000 Mbps duplex: unknown mac: 02:42:c5:e3:15:1a
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IP v6: fe80::42:c5ff:fee3:151a/64 virtual: proto kernel_ll scope: link
  ...
  IF-ID-5: veth474e87a state: up speed: 10000 Mbps duplex: full mac: b6:1d:58:18:50:dd
  IF-ID-6: vethde882da state: up speed: 10000 Mbps duplex: full mac: 32:70:6d:e5:25:8a
  Info: services: sshd, systemd-networkd, systemd-timesyncd
  WAN IP: 131.159.102.9
RAID:
  Hardware-1: Broadcom / LSI MegaRAID SAS-3 3008 [Fury] driver: megaraid_sas v: 07.725.01.00-rc1
    port: 1000 bus-ID: 01:00.0 chip-ID: 1000:005f rev: N/A class-ID: 0104
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 3.48 TiB free: 2.13 TiB
    allocated: 1.35 TiB zfs-fs: size: 3.38 TiB free: 2.02 TiB
  Components: Online:
