...
```
System:
  Host: graham Kernel: 6.18.6 arch: x86_64 bits: 64 compiler: gcc v: 14.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\hyzi4il19yzwqkvjfslnfm1nn6r2q57d-initrd-linux-6.18.6-initrd.efi
    init=/nix/store/r6a02v035vfp02qmhsbkaqqaf76alfdq-nixos-system-graham-25.11.20260123.ac3d985/init
    ...
    hugepagesz=2MB hugepages=153600 nohibernate loglevel=4 lsm=landlock,yama,bpf
...
Memory:
  System RAM: total: 1024 GiB available: 991.23 GiB used: 580.97 GiB (58.6%)
...
CPU:
  ...
  Speed (MHz): avg: 1500 min/max: 1500/3721 boost: enabled base/boost: 2000/3900 scaling:
...
Graphics:
  ...
  Display: unspecified server: X.org v: 1.21.1.20 driver: gpu: mgag200 tty: 80x40
...
Network:
  ...
  IF: ens1f0np0 state: up speed: 10000 Mbps duplex: full mac: 2c:ea:7f:af:57:18
  ...
  IF: ens1f1np1 state: down mac: 2c:ea:7f:af:57:19
  Device-3: Intel Ethernet E810-C for QSFP driver: N/A modules: ice pcie: gen: 3 speed: 8 GT/s
    lanes: 16 link-max: gen: 4 speed: 16 GT/s port: N/A bus-ID: 81:00.0 chip-ID: 8086:1592
    class-ID: 0200
  Device-4: Intel Ethernet E810-C for QSFP driver: N/A modules: ice pcie: gen: 3 speed: 8 GT/s
  ...
  Device-7: Broadcom BCM57416 NetXtreme-E Dual-Media 10G RDMA Ethernet driver: bnxt_en v: kernel
    ...
    temp: 36.0 C
  IF: ens3f0np0 state: up speed: 10000 Mbps duplex: full mac: e4:3d:1a:71:d6:b0
  IP v4: 169.254.221.205/16 scope: link
  ...
  IF: ens3f1np1 state: up speed: 10000 Mbps duplex: full mac: e4:3d:1a:71:d6:b1
  IP v4: 169.254.201.129/16 scope: link
  IP v6: fe80::e63d:1aff:fe71:d6b1/64 virtual: proto kernel_ll scope: link
  IF-ID-1: br-33389a0306b4 state: down mac: ae:16:33:bf:59:8e
  IP v4: 172.18.0.1/16 scope: global broadcast: 172.18.255.255
  IF-ID-2: docker0 state: down mac: 36:09:5d:5e:d6:4a
...
RAID:
  Hardware-1: Broadcom / LSI MegaRAID SAS-3 3008 [Fury] driver: megaraid_sas v: 07.734.00.00-rc1
    port: 1000 bus-ID: 01:00.0 chip-ID: 1000:005f rev: N/A class-ID: 0104
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 3.48 TiB free: 905 GiB
    allocated: 2.6 TiB zfs-fs: size: 3.41 TiB free: 794.2 GiB
  Components: Online:
  1: nvme1n1p2 maj-min: 259:4 size: 3.49 TiB
Drives:
  Local Storage: total: raw: 4.95 TiB usable: 4.86 TiB used: 2.04 TiB (41.9%)
  ID-1: /dev/nvme0n1 maj-min: 259:1 vendor: Dell model: Ent NVMe AGN MU AIC 1.6TB size: 1.46 TiB
    ...
    temp: 16 ° (289 K) C
  SMART: yes health: PASSED on: 4y 168d 9h cycles: 55 read-units: 253,537,578 [129 TB]
  ...
  ID-2: /dev/nvme1n1 maj-min: 259:2 vendor: Samsung model: MZ1L23T8HBLA-00A07 size: 3.49 TiB
    ...
    serial: S667NJ0T732147 fw-rev: GDC7302Q temp: 24.9 C scheme: GPT
  SMART: yes health: PASSED on: 2y 81d 19h cycles: 32 read-units: 149,688,106 [76.6 TB]
    written-units: 384,007,338 [196 TB]
Partition:
  ID-1: / raw-size: N/A size: 2.81 TiB used: 2.04 TiB (72.4%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 32.8 MiB (3.2%) fs: vfat
    block-size: 512 B dev: /dev/nvme1n1p1 maj-min: 259:3
  ID-3: /home raw-size: N/A size: 3.47 TiB used: 2.54 TiB (73.3%) fs: nfs4
    remote: nfs:/export/home
  ID-4: /tmp raw-size: N/A size: 794.36 GiB used: 166.8 MiB (0.0%) fs: zfs
...
Sensors:
  ...
  Src: lm-sensors System Temperatures: cpu: 42.2 C mobo: 42.0 C
  Fan Speeds (rpm): N/A
Info:
  Processes: 1020 Power: uptime: 57d 10h 1m states: freeze,mem suspend: s2idle wakeups: 0
    hibernate: disabled image: 396.48 GiB Init: systemd v: 258 default: graphical tool: systemctl
  Packages: pm: nix-default pkgs: 0 pm: nix-sys pkgs: 1013 libs: 237 pm: nix-usr pkgs: 0
