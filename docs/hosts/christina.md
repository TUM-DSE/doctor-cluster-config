...
```
System:    Host: christina Kernel: 6.4.16 x86_64 bits: 64 compiler: gcc v: 12.2.0 
           parameters: initrd=\efi\nixos\9vy6i0mmlzhyrcrrgjrwp3z2jic0rz3d-initrd-linux-6.4.16-initrd.efi 
           init=/nix/store/m1sppndkzwl9z4wm5pvci24gcygnxb10-nixos-system-christina-23.05.20230927.3048712/init 
...
Memory:    RAM: total: 251.21 GiB used: 22.61 GiB (9.0%) 
...
CPU:       Info: 12-Core model: Intel Xeon Gold 5317 socket: LGA4189 bits: 64 type: MCP 
           ...
           Speed: 3487 MHz min/max: 800/3600 MHz base/boost: 3000/4500 volts: 1.6 V 
           ext-clock: 100 MHz Core speeds (MHz): 1: 3487 2: 3600 3: 3600 4: 3600 5: 3600 6: 2817 
           7: 3600 8: 3600 9: 3600 10: 3295 11: 3600 12: 3600 
...
Network:   Device-1: Intel Ethernet X550 vendor: Super Micro driver: ixgbe v: kernel port: 0780 
           ...
           IF-ID-1: docker0 state: down mac: 02:42:ed:f6:ae:1b 
           IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255 
           IF-ID-2: docker_gwbridge state: down mac: 02:42:c9:0e:44:70 
...
Drives:    Local Storage: total: raw: 3.49 TiB usable: 5.22 TiB used: 332.47 GiB (6.2%) 
           ...
           SMART: yes state: enabled 
Partition: ID-1: / raw-size: N/A size: 1.51 TiB used: 308.22 GiB (19.9%) fs: zfs 
...
Info:      Processes: 324 
           Uptime: 13:02:19  up 19 days 12:47,  24 users,  load average: 0.27, 0.22, 0.13 
