...
```
System:    Host: christina Kernel: 6.1.29 x86_64 bits: 64 compiler: gcc v: 11.3.0 
           parameters: initrd=\efi\nixos\sdzrcvlp23r0gbdfwscl431zwfshwmk3-initrd-linux-6.1.29-initrd.efi 
           init=/nix/store/lzb3mhy6dp5v82xavqwy5i3fksa2frah-nixos-system-christina-22.11.20230523.fc06fd7/init 
...
Memory:    RAM: total: 251.21 GiB used: 91.09 GiB (36.3%) 
...
CPU:       Info: 12-Core model: Intel Xeon Gold 5317 socket: LGA4189 bits: 64 type: MCP 
           ...
           ext-clock: 100 MHz Core speeds (MHz): 1: 3600 2: 2111 3: 3600 4: 3600 5: 3600 6: 3600 
           7: 3600 8: 3600 9: 3600 10: 3600 11: 3600 12: 1782 
...
Network:   Device-1: Intel Ethernet X550 vendor: Super Micro driver: ixgbe v: kernel port: 0780 
           ...
           IF-ID-1: docker0 state: down mac: 02:42:d9:75:31:39 
           IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255 
           IF-ID-2: docker_gwbridge state: down mac: 02:42:82:99:7b:a0 
           IP v4: 172.18.0.1/16 scope: global broadcast: 172.18.255.255 
           IF-ID-3: tap0 state: down mac: 42:67:f9:aa:61:81 
           IP v4: 10.0.0.1/24 scope: global 
           IP v6: fe80::4067:f9ff:feaa:6181/64 scope: link 
...
Drives:    Local Storage: total: 3.49 TiB used: 1.74 TiB (49.9%) 
           ...
           SMART: yes state: enabled 
Partition: ID-1: / raw-size: N/A size: 1.51 TiB used: 315.95 GiB (20.4%) fs: zfs 
           logical: zroot/root/nixos 
           ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 34.6 MiB (3.4%) fs: vfat 
...
Info:      Processes: 334 
           Uptime: 15:02:06  up 12 days 14:46,  25 users,  load average: 0.19, 0.23, 0.14 
           wakeups: 0 Init: systemd v: 251 target: multi-user.target tool: systemctl Compilers: 
           gcc: 11.3.0 Packages: nix-default: 0 nix-sys: 385 lib: 62 nix-usr: 0 Client: Sudo 
