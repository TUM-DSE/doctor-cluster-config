...
```
System:
  Host: christina Kernel: 6.6.56 arch: x86_64 bits: 64 compiler: gcc v: 13.2.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\0wf99jrfs9vifdprhws7skc3g0d069mn-initrd-linux-6.6.56-initrd.efi
    init=/nix/store/x7bqqjy4q3h2a3306drjf3l41mwmwg00-nixos-system-christina-24.05.20241018.07f7c53/init
...
Machine:
  ...
  Mobo: Supermicro model: X12SPW-TF v: 2.00 serial: OM21AS002555
    ...
    date: 11/08/2021
Memory:
  System RAM: total: 256 GiB available: 235.45 GiB used: 14.37 GiB (6.1%)
...
CPU:
  ...
  Speed (MHz): avg: 1105 high: 3000 min/max: 800/3600 base/boost: 3000/4500 scaling:
    driver: intel_cpufreq governor: schedutil volts: 1.6 V ext-clock: 100 MHz cores: 1: 800 2: 800
    3: 2263 4: 800 5: 800 6: 800 7: 3000 8: 800 9: 800 10: 800 11: 800 12: 800 bogomips: 72000
...
Network:
  ...
  IP v6: fe80::3eec:efff:fe62:ad7c/64 virtual: proto kernel_ll scope: link
  ...
  IP v6: fe80::3eec:efff:fe62:ad7d/64 virtual: proto kernel_ll scope: link
  ...
  IF-ID-1: docker0 state: down mac: 02:42:6c:d7:01:15
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IF-ID-2: docker_gwbridge state: down mac: 02:42:98:e8:41:3b
...
RAID:
  ...
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 1.19 TiB
    allocated: 561 GiB zfs-fs: size: 1.68 TiB free: 1.13 TiB
  Components: Online:
  1: sdb2 maj-min: 8:18 size: 1.75 TiB
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.43 TiB used: 385.34 GiB (11.0%)
  ...
  SMART: yes state: enabled
Partition:
  ID-1: / raw-size: N/A size: 1.51 TiB used: 385.31 GiB (24.9%) fs: zfs logical: zroot/root/nixos
...
Sensors:
  Src: ipmi System Temperatures: cpu: 42 C mobo: 31 C
  Fan Speeds (rpm): cpu: 5320 fan-2: 5320 fan-3: 5180 fan-4: 5180 fan-5: 5180 fan-6: 5320
  Power: 12v: 11.590 5v: 5.040 3.3v: 3.345 vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 37.0 C pch: 54.0 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 330 Power: uptime: 0h 3m states: freeze,mem suspend: s2idle wakeups: 0
    hibernate: disabled image: 90.97 GiB Init: systemd v: 255 default: multi-user tool: systemctl
