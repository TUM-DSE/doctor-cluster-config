...
```
System:
  Host: christina Kernel: 6.16.9 arch: x86_64 bits: 64 compiler: gcc v: 14.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\0rykqqjbv0sr4xb4dp2vzpdjz13ab72k-initrd-linux-6.16.9-initrd.efi
    init=/nix/store/7cfdx5iz4ipr2r9fgz0895j64lczqdad-nixos-system-christina-25.05.20250930.51fcc5b/init
...
Machine:
  ...
  Mobo: Supermicro model: X12SPW-TF v: 2.00 serial: OM21AS002555
    ...
    date: 11/08/2021
Memory:
  System RAM: total: 256 GiB available: 247.45 GiB used: 35.68 GiB (14.4%)
...
CPU:
  ...
  Speed (MHz): avg: 1453 min/max: 800/3000 base/boost: 3000/4500 scaling: driver: intel_cpufreq
    governor: schedutil volts: 1.6 V ext-clock: 100 MHz cores: 1: 1453 2: 1453 3: 1453 4: 1453
    5: 1453 6: 1453 7: 1453 8: 1453 9: 1453 10: 1453 11: 1453 12: 1453 bogomips: 72000
...
Network:
  ...
  Device-2: Intel Ethernet X550 vendor: Super Micro driver: vfio-pci v: N/A modules: ixgbe pcie:
    gen: 3 speed: 8 GT/s lanes: 4 port: N/A bus-ID: 01:00.1 chip-ID: 8086:1563 class-ID: 0200
  ...
  IF: ens2f0 state: up speed: 10000 Mbps duplex: full mac: 00:1b:21:c3:85:e0
  ...
  IF: ens2f1 state: down mac: 00:1b:21:c3:85:e2
  IF-ID-1: docker0 state: down mac: 02:42:a8:82:6e:d1
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IF-ID-2: docker_gwbridge state: down mac: 02:42:92:b5:00:80
...
RAID:
  ...
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 1.27 TiB
    allocated: 477 GiB zfs-fs: size: 1.68 TiB free: 1.21 TiB
  Components: Online:
  1: sdb2 maj-min: 8:18 size: 1.75 TiB
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.43 TiB used: 300.36 GiB (8.6%)
  ID-1: /dev/sda maj-min: 8:0 vendor: Samsung model: MZ1L21T9 size: 1.75 TiB block-size:
    physical: 512 B logical: 512 B speed: <unknown> tech: SSD serial: N/A fw-rev: 102Q temp: 31 C
  ...
  SMART: yes state: enabled
Partition:
  ID-1: / raw-size: N/A size: 1.51 TiB used: 300.32 GiB (19.4%) fs: zfs logical: zroot/root/nixos
...
Sensors:
  Src: ipmi System Temperatures: cpu: 48 C mobo: 29 C
  Fan Speeds (rpm): cpu: 7140 fan-2: 7000 fan-3: 7140 fan-4: 7000 fan-5: 7000 fan-6: 7140
  Power: 12v: 11.508 5v: 5.040 3.3v: 3.345 vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 42.0 C pch: 52.0 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 349 Power: uptime: 6d 6h 26m states: freeze,mem suspend: s2idle wakeups: 0
    hibernate: disabled image: 95.76 GiB Init: systemd v: 257 default: multi-user tool: systemctl
  Packages: pm: nix-default pkgs: 0 pm: nix-sys pkgs: 606 libs: 137 pm: nix-usr pkgs: 0
