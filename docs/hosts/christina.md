...
```
System:
  Host: christina Kernel: 6.12.66 arch: x86_64 bits: 64 compiler: gcc v: 14.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\039fyl3bgnsmwbzn4b14ni44x7z91fv8-initrd-linux-6.12.66-initrd.efi
    init=/nix/store/d8mvm4zsm5mljh6cqk1ni3ncrvi6q37z-nixos-system-christina-25.11.20260123.ac3d985/init
...
Machine:
  ...
  Mobo: Supermicro model: X12SPW-TF v: 2.00 serial: OM21AS002555
    ...
    date: 11/08/2021
Memory:
  System RAM: total: 256 GiB available: 247.45 GiB used: 22.11 GiB (8.9%)
...
CPU:
  ...
  Speed (MHz): avg: 801 min/max: 800/3600 base/boost: 3000/4500 scaling: driver: intel_cpufreq
    ...
    6: 801 7: 801 8: 801 9: 801 10: 801 11: 801 12: 801 bogomips: 72000
...
Network:
  ...
  IF-ID-1: docker0 state: down mac: 26:7b:f6:f2:d1:c3
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IF-ID-2: docker_gwbridge state: down mac: 56:2c:87:d0:bb:22
...
RAID:
  ...
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 1.73 TiB free: 1.26 TiB
    allocated: 487 GiB zfs-fs: size: 1.68 TiB free: 1.21 TiB
  Components: Online:
  1: sdb2 maj-min: 8:18 size: 1.75 TiB
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.43 TiB used: 283.89 GiB (8.1%)
  ...
  SMART: yes state: enabled
Partition:
  ID-1: / raw-size: N/A size: 1.48 TiB used: 283.85 GiB (18.7%) fs: zfs logical: zroot/root/nixos
...
Sensors:
  Src: ipmi System Temperatures: cpu: 33 C mobo: 26 C
  Fan Speeds (rpm): cpu: 7140 fan-2: 7140 fan-3: 7140 fan-4: 7140 fan-5: 7000 fan-6: 7140
  Power: 12v: 11.590 5v: 5.040 3.3v: 3.345 vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 28.0 C pch: 47.0 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 320 Power: uptime: 1d 10h 24m states: freeze,mem suspend: s2idle wakeups: 0
    hibernate: disabled image: 95.76 GiB Init: systemd v: 258 default: multi-user tool: systemctl
