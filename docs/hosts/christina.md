...
```
System:
  Host: christina Kernel: 6.12.12 arch: x86_64 bits: 64 compiler: gcc v: 13.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\4xly849ysmcfp1p90myqh7fhldd58442-initrd-linux-6.12.12-initrd.efi
    init=/nix/store/fdcfhx73z4a3jzks1503i21xqbv2jgdz-nixos-system-christina-24.11.20250209.392aa11/init
...
Machine:
  ...
  Mobo: Supermicro model: X12SPW-TF v: 2.00 serial: OM21AS002555
    ...
    date: 11/08/2021
Memory:
  System RAM: total: 256 GiB available: 247.45 GiB used: 31.96 GiB (12.9%)
...
CPU:
  ...
  Speed (MHz): avg: 1966 high: 3000 min/max: 800/3000 base/boost: 3000/4500 scaling:
    driver: intel_cpufreq governor: schedutil volts: 1.6 V ext-clock: 100 MHz cores: 1: 2362 2: 1661
    3: 2156 4: 2651 5: 2044 6: 1282 7: 3000 8: 1781 9: 1415 10: 3000 11: 786 12: 1455
    bogomips: 72000
...
Network:
  ...
  IF-ID-1: docker0 state: down mac: 02:42:7e:c7:30:00
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IF-ID-2: docker_gwbridge state: down mac: 02:42:ae:ee:6f:a0
...
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.43 TiB used: 405.41 GiB (11.5%)
  ...
  SMART: yes state: enabled
Partition:
  ID-1: / raw-size: N/A size: 1.51 TiB used: 405.38 GiB (26.2%) fs: zfs logical: zroot/root/nixos
...
Sensors:
  Src: ipmi System Temperatures: cpu: 46 C mobo: 30 C
  Fan Speeds (rpm): cpu: 8120 fan-2: 8260 fan-3: 8120 fan-4: 8260 fan-5: 7980 fan-6: 8260
  Power: 12v: 11.508 5v: 5.040 3.3v: 3.345 vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 41.0 C pch: 53.0 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 379 Power: uptime: 3d 23h 20m states: freeze,mem suspend: s2idle wakeups: 0
