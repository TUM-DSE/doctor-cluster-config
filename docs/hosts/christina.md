...
```
System:    Host: christina Kernel: 6.5.10 x86_64 bits: 64 compiler: gcc v: 12.2.0 
           parameters: initrd=\efi\nixos\w5w2iqg106v54yky74b0h31lzwmwvsjs-initrd-linux-6.5.10-initrd.efi 
           init=/nix/store/98hlxck3cjr3krrpw6lg7r55wnc5ixlb-nixos-system-christina-23.05.20231105.6770e7f/init 
...
Memory:    RAM: total: 251.21 GiB used: 22.46 GiB (8.9%) 
...
CPU:       Info: 12-Core model: Intel Xeon Gold 5317 socket: LGA4189 bits: 64 type: MCP 
           ...
           ext-clock: 100 MHz Core speeds (MHz): 1: 3600 2: 3600 3: 3600 4: 2771 5: 3600 6: 1095 
           7: 3600 8: 3600 9: 3569 10: 3600 11: 3600 12: 2637 
...
Network:   Device-1: Intel Ethernet X550 vendor: Super Micro driver: ixgbe v: kernel port: 0780 
           ...
           IF: enp24s0f1np1 state: down mac: b4:96:91:aa:a1:c1 
           ...
           IF-ID-1: docker0 state: down mac: 02:42:b9:61:7d:62 
           IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255 
           IF-ID-2: docker_gwbridge state: down mac: 02:42:ad:87:d7:d2 
...
Drives:    Local Storage: total: 3.49 TiB used: 2.52 TiB (72.0%) 
           ...
           temp: 26 C 
           SMART: yes state: enabled 
Partition: ID-1: / raw-size: N/A size: 1.51 TiB used: 309.38 GiB (20.0%) fs: zfs 
           logical: zroot/root/nixos 
           ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 137.7 MiB (13.5%) fs: vfat 
...
Info:      Processes: 320 
           Uptime: 09:11:37  up 1 day 11:12,  0 users,  load average: 0.12, 0.14, 0.15 wakeups: 0 
           Init: systemd v: 253 target: multi-user.target tool: systemctl Compilers: gcc: 12.2.0 
           Packages: nix-default: 0 nix-sys: 558 lib: 124 nix-usr: 0 Client: Sudo v: 1.9.13p3 
           inxi: 3.3.04 
```
