...
```
System:
  Host: ryan Kernel: 6.8.0 arch: x86_64 bits: 64 compiler: gcc v: 13.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\qlcfm3dvf519f2m8nm6qjq8j63wbksyq-initrd-linux-6.8-vcreflection-initrd.efi
    init=/nix/store/iivbk0wg7f7yislnwgfs178b9cdv1kky-nixos-system-ryan-24.11.20250120.643e964/init
  ...
  Console: pty pts/12 DM: LightDM v: 1.32.0 Distro: NixOS 24.11 (Vicuna)
Machine:
...
Memory:
  System RAM: total: 1024 GiB available: 991.23 GiB used: 135.28 GiB (13.6%)
...
CPU:
  ...
  Speed (MHz): avg: 1507 high: 2000 min/max: 1500/3721 boost: disabled base/boost: 2000/3900
    ...
    43: 1500 44: 1500 45: 1500 46: 1500 47: 1500 48: 1500 49: 1500 50: 2000 51: 1500 52: 1500
    53: 1500 54: 1500 55: 1500 56: 1500 57: 1500 58: 1500 59: 1500 60: 1500 61: 1500 62: 1500
    63: 1500 64: 1500 bogomips: 255528
...
Network:
  ...
  IF-ID-1: docker0 state: down mac: 02:42:5d:84:e9:14
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IP v6: fe80::42:5dff:fe84:e914/64 virtual: proto kernel_ll scope: link
  IF-ID-2: tap0_michael state: down mac: 96:14:9b:89:39:0e
  IP v4: 10.10.51.1/24 scope: global
  IP v6: fe80::9414:9bff:fe89:390e/64 virtual: proto kernel_ll scope: link
  IF-ID-3: tap0_patrick state: up speed: 10000 Mbps duplex: full mac: 72:66:d4:ad:aa:55
...
RAID:
  ...
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 1.45 TiB free: 522 GiB
    allocated: 966 GiB zfs-fs: size: 1.41 TiB free: 475.52 GiB
  Components: Online:
  1: nvme1n1p2 maj-min: 259:8 size: 1.45 TiB
Drives:
  Local Storage: total: raw: 5.3 TiB usable: 5.25 TiB used: 784.72 GiB (14.6%)
  ID-1: /dev/nvme0n1 maj-min: 259:6 vendor: Dell model: Ent NVMe AGN MU AIC 1.6TB size: 1.46 TiB
    block-size: physical: 512 B logical: 512 B tech: SSD serial: S61ANA0T700017 fw-rev: 2.0.2
    temp: 21 ° (294 K) C
  SMART: yes health: PASSED on: 1y 168d 17h cycles: 15 read-units: 24,190,292 [12.3 TB]
    written-units: 16,330,485 [8.36 TB]
  ID-2: /dev/nvme1n1 maj-min: 259:5 vendor: Dell model: Ent NVMe AGN MU AIC 1.6TB size: 1.46 TiB
    block-size: physical: 4096 B logical: 4096 B tech: SSD serial: S61ANA0T700063 fw-rev: 2.0.2
    temp: 21 ° (294 K) C scheme: GPT
  SMART: yes health: PASSED on: 1y 168d 17h cycles: 15 read-units: 15,572,757 [7.97 TB]
    written-units: 34,398,896 [17.6 TB]
  ID-3: /dev/nvme2n1 maj-min: 259:9 vendor: Samsung model: SSD 970 EVO Plus 1TB size: 931.51 GiB
    ...
    serial: S4EWNX0R513894H fw-rev: 2B2QEXM7 temp: 32.9 C
  SMART: yes health: PASSED on: 145d 17h cycles: 23 read-units: 144,370,105 [73.9 TB]
  ...
  ID-4: /dev/nvme3n1 maj-min: 259:0 vendor: SK Hynix model: PC801 NVMe 1TB size: 953.87 GiB
    ...
    serial: SNB5N744011305V1P fw-rev: 51002141 temp: 36.9 C scheme: GPT
  SMART: yes health: PASSED on: 1y 239d 18h cycles: 127 read-units: 2,385,188 [1.22 TB]
    written-units: 5,705,019 [2.92 TB]
  ID-5: /dev/sda maj-min: 8:0 model: AL15SEB060NY size: 558.91 GiB block-size: physical: 512 B
    logical: 512 B speed: <unknown> tech: HDD rpm: 10000 serial: N/A fw-rev: EF06 temp: 24 C
  SMART: yes state: enabled
Partition:
  ID-1: / raw-size: N/A size: 1.23 TiB used: 781.29 GiB (62.2%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1021.9 MiB (99.79%) used: 57.6 MiB (5.6%) fs: vfat
    block-size: 4096 B dev: /dev/nvme1n1p1 maj-min: 259:7
  ID-3: /home raw-size: N/A size: 2.72 TiB used: 1.86 TiB (68.7%) fs: nfs4
    remote: nfs:/export/home
  ID-4: /tmp raw-size: N/A size: 478.89 GiB used: 3.37 GiB (0.7%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu: N/A mobo: N/A
  Fan Speeds (rpm): cpu: 9720 mobo: 9960 fan-3: 10080 fan-4: 9840 fan-5: 9960 fan-6: 10080
  Power: 12v: N/A 5v: N/A 3.3v: N/A vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 43.6 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 994 Power: uptime: 23d 1h 18m states: freeze,mem suspend: s2idle wakeups: 0
