...
System:
  Host: ryan Kernel: 6.8.0 arch: x86_64 bits: 64 compiler: gcc v: 13.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\aidjs2q1n2in3nqfk3r488q4isj7dm66-initrd-linux-6.8-vcreflection-initrd.efi
    init=/nix/store/rl0l8269i956iq5zpl2059vjk3p3ghrx-nixos-system-ryan-24.11.20250209.392aa11/init
...
Memory:
  System RAM: total: 1024 GiB available: 991.23 GiB used: 43.86 GiB (4.4%)
...
CPU:
  ...
  Speed (MHz): avg: 1507 high: 2000 min/max: 1500/3721 boost: disabled base/boost: 2000/3900
    ...
    43: 1500 44: 1500 45: 1500 46: 1500 47: 1500 48: 1500 49: 1500 50: 1500 51: 2000 52: 1500
    53: 1500 54: 1500 55: 1500 56: 1500 57: 1500 58: 1500 59: 1500 60: 1500 61: 1500 62: 1500
    63: 1500 64: 1500 bogomips: 255523
...
Network:
  ...
  IF-ID-1: docker0 state: down mac: 02:42:1f:a1:5b:65
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IP v6: fe80::42:1fff:fea1:5b65/64 virtual: proto kernel_ll scope: link
...
RAID:
  ...
  Device-1: zroot type: zfs status: ONLINE level: linear raw: size: 1.45 TiB free: 534 GiB
    allocated: 954 GiB zfs-fs: size: 1.41 TiB free: 487.73 GiB
  Components: Online:
  1: nvme1n1p2 maj-min: 259:8 size: 1.45 TiB
Drives:
  Local Storage: total: raw: 5.3 TiB usable: 5.25 TiB used: 784.19 GiB (14.6%)
  ID-1: /dev/nvme0n1 maj-min: 259:5 vendor: Dell model: Ent NVMe AGN MU AIC 1.6TB size: 1.46 TiB
    ...
    temp: 20 ° (293 K) C
  SMART: yes health: PASSED on: 1y 176d 22h cycles: 15 read-units: 24,190,305 [12.3 TB]
  ...
  ID-2: /dev/nvme1n1 maj-min: 259:6 vendor: Dell model: Ent NVMe AGN MU AIC 1.6TB size: 1.46 TiB
    ...
    temp: 20 ° (293 K) C scheme: GPT
  SMART: yes health: PASSED on: 1y 176d 22h cycles: 15 read-units: 15,606,580 [7.99 TB]
    written-units: 35,325,529 [18.0 TB]
  ...
  SMART: yes health: PASSED on: 145d 17h cycles: 23 read-units: 144,370,118 [73.9 TB]
  ...
  ID-4: /dev/nvme3n1 maj-min: 259:0 vendor: SK Hynix model: PC801 NVMe 1TB size: 953.87 GiB
    ...
    serial: SNB5N744011305V1P fw-rev: 51002141 temp: 33.9 C scheme: GPT
  SMART: yes health: PASSED on: 1y 247d 23h cycles: 127 read-units: 2,385,223 [1.22 TB]
    written-units: 5,705,019 [2.92 TB]
  ID-5: /dev/sda maj-min: 8:0 model: AL15SEB060NY size: 558.91 GiB block-size: physical: 512 B
    logical: 512 B speed: <unknown> tech: HDD rpm: 10000 serial: N/A fw-rev: EF06 temp: 22 C
  SMART: yes state: enabled
Partition:
  ID-1: / raw-size: N/A size: 1.24 TiB used: 784.16 GiB (61.7%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1021.9 MiB (99.79%) used: 29 MiB (2.8%) fs: vfat
    block-size: 4096 B dev: /dev/nvme1n1p1 maj-min: 259:7
  ID-3: /home raw-size: N/A size: 2.71 TiB used: 1.98 TiB (73.1%) fs: nfs4
    remote: nfs:/export/home
  ID-4: /tmp raw-size: N/A size: 487.73 GiB used: 2 MiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu: N/A mobo: N/A
  Fan Speeds (rpm): cpu: 9840 mobo: 9960 fan-3: 9960 fan-4: 9960 fan-5: 10080 fan-6: 9960
  Power: 12v: N/A 5v: N/A 3.3v: N/A vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 40.6 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 989 Power: uptime: 4d 14h 31m states: freeze,mem suspend: s2idle wakeups: 0
