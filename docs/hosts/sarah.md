...
CPU:       Info: 8-Core model: Apple M1 bits: 64 type: MCP arch: N/A rev: cache: L1: 128 KiB L2: 4 MiB note: check 
...
Graphics:  Message: No ARM data found for this feature. 
           Display: server: No display server data found. Headless machine? tty: 155x75 
...
Network:   Message: No ARM data found for this feature. 
           ...
           IF-ID-3: en0 state: active speed: 1000baseT duplex: full-duplex,flow-control mac: 14:98:77:34:31:7a 
           IP v6: fe80::433:5af0:f8d7:88f1%en0 scope: link 
           ...
           IF-ID-9: en1 state: inactive speed: <unknown duplex: type> mac: 14:98:77:3c:22:dc 
           IF-ID-10: bridge0 state: inactive speed: N/A duplex: N/A mac: 36:09:76:7a:36:00 
           IF-ID-11: awdl0 state: inactive speed: N/A duplex: N/A mac: 62:e4:ca:ac:2c:56 
           IF-ID-12: llw0 state: inactive speed: N/A duplex: N/A mac: 62:e4:ca:ac:2c:56 
           IP v6: fe80::60e4:caff:feac:2c56%llw0 scope: link 
           WAN IP: ;; connection timed out; no servers could be reached 
Drives:    Local Storage: total: dmesg.boot not found used: 39.16 GiB 
...
Info:      Processes: 203 Uptime: 11:36:23  up 19 days  1:06,  1 user,  load average: 1.07, 1.16, 1.13 Init: launchd v: N/A 
           Compilers: gcc: N/A clang: 12.0.5 Packages: 61 nix-default: 55 nix-usr: 6 Shell: Bash (sudo) v: 3.2.57 
           running-in: tty s000 (SSH) inxi: 3.3.04 
```
![hardware topology](sarah.lstopo.svg)
