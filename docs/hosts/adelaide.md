...
```
System:
  Host: adelaide Kernel: 6.12.10 arch: x86_64 bits: 64 compiler: gcc v: 13.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\hh2bdcra2fcrkw41vax57kmz6gh5w3bp-initrd-linux-6.12.10-initrd.efi
    init=/nix/store/jidhixr4nbn1yi2lqw8411076c8f511z-nixos-system-adelaide-24.11.20250120.643e964/init
...
Machine:
  ...
  Mobo: Supermicro model: X12SPW-TF v: 2.00 serial: OM21AS002614
    ...
    date: 11/08/2021
Memory:
  System RAM: total: 1.25 TiB available: 251.2 GiB used: 38.77 GiB (15.4%)
...
CPU:
  ...
  Speed (MHz): avg: 2643 high: 3000 min/max: 800/3000 base/boost: 3000/4500 scaling:
    driver: intel_cpufreq governor: schedutil volts: 1.6 V ext-clock: 100 MHz cores: 1: 3000 2: 2435
    3: 2673 4: 3000 5: 3000 6: 3000 7: 800 8: 2029 9: 3000 10: 3000 11: 3000 12: 2782
    bogomips: 72000
...
Network:
  ...
  IF-ID-4: docker0 state: down mac: 02:42:fd:17:8b:08
  IP v4: 172.17.0.1/16 scope: global broadcast: 172.17.255.255
  IF-ID-5: eth0 state: unknown speed: -1 duplex: half mac: be:3a:f2:b6:05:9f
  IP v4: 169.254.3.1/24 type: dynamic scope: global
  IP v6: fe80::bc3a:f2ff:feb6:59f/64 virtual: proto kernel_ll scope: link
  IF-ID-6: tap-okelmann state: down mac: 7e:1c:ed:68:2b:7e
  IP v6: fe80::7c1c:edff:fe68:2b7e/64 virtual: proto kernel_ll scope: link
  IF-ID-7: tapa-okelmann0 state: down mac: 96:b2:60:25:7d:70
...
Drives:
  Local Storage: total: raw: 3.49 TiB usable: 3.43 TiB used: 52.8 GiB (1.5%)
  ...
  SMART: yes state: enabled
Partition:
  ID-1: / raw-size: N/A size: 1.66 TiB used: 52.72 GiB (3.1%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 74.1 MiB (7.3%) fs: vfat
    block-size: 512 B dev: /dev/sdb1 maj-min: 8:17
  ID-3: /home raw-size: N/A size: 2.72 TiB used: 1.86 TiB (68.7%) fs: nfs4
    remote: nfs:/export/home
  ID-4: /tmp raw-size: N/A size: 1.61 TiB used: 5.6 MiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu: 51 C mobo: 31 C
  Fan Speeds (rpm): cpu: 8120 fan-2: 7980 fan-3: 8120 fan-4: 8120 fan-5: 8260 fan-6: 8260
  Power: 12v: 11.590 5v: 5.081 3.3v: 3.322 vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 48.0 C pch: 52.0 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 380 Power: uptime: 24d 9h 39m states: freeze,mem suspend: s2idle wakeups: 0
