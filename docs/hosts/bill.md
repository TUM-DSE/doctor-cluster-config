...
```
System:    Host: bill Kernel: 6.1.8 x86_64 bits: 64 compiler: gcc v: 11.3.0 
           parameters: initrd=\efi\nixos\7x70by4d6wxk6lgg2rn735gcalf30alw-initrd-linux-6.1.8-initrd.efi 
           init=/nix/store/2srxdb3ma7brwpjkkd2a7b8m68hs3s2q-nixos-system-bill-22.11.20230128.0945db2/init 
...
Memory:    RAM: total: 125.68 GiB used: 19.29 GiB (15.4%) 
...
CPU:       Info: 10-Core model: Intel Core i9-10900K bits: 64 type: MT MCP arch: Comet Lake 
           ...
           Speed: 5102 MHz min/max: 800/5300 MHz base/boost: 3600/3700 volts: 1.0 V 
           ext-clock: 100 MHz Core speeds (MHz): 1: 5102 2: 3700 3: 5091 4: 3700 5: 3700 6: 3700 
           7: 5003 8: 5001 9: 5098 10: 3700 11: 3700 12: 3700 13: 4998 14: 5006 15: 5023 16: 3700 
...
Network:   Device-1: Intel Ethernet I219-LM vendor: Super Micro driver: e1000e v: kernel 
           ...
           IF-ID-3: br-9445ed3d463d state: down mac: 02:42:84:12:a7:2c 
           IP v4: 192.168.49.1/24 scope: global broadcast: 192.168.49.255 
           IF-ID-4: docker0 state: down mac: 02:42:2f:e9:aa:61 
...
RAID:      Device-1: zpool1 type: zfs status: ONLINE level: linear size: 928 GiB free: 310 GiB 
           allocated: 618 GiB 
           Components: Online: N/A 
           Device-2: zpool2 type: zfs status: ONLINE level: linear size: 14.5 TiB free: 13.9 TiB 
           allocated: 698 GiB 
           Components: Online: N/A 
           Device-3: zroot type: zfs status: ONLINE level: linear size: 888 GiB free: 739 GiB 
           allocated: 149 GiB 
           Components: Online: N/A 
Drives:    Local Storage: total: raw: 16.34 TiB usable: 32.61 TiB used: 96.79 GiB (0.3%) 
           ...
           SMART: yes health: PASSED on: 73d 4h cycles: 2 read-units: 75,696,409 [38.7 TB] 
           written-units: 6,576,679 [3.36 TB] 
           ...
           scheme: GPT 
           SMART: yes state: enabled health: PASSED on: 1y 343d 12h cycles: 36 read: 23.95 TiB 
           written: 52.76 TiB 
           ...
           SMART: yes state: enabled health: PASSED on: 1y 115d 23h cycles: 1 
Partition: ID-1: / raw-size: N/A size: 807.14 GiB used: 96.69 GiB (12.0%) fs: zfs 
           logical: zroot/root/nixos 
           ID-2: /boot raw-size: 500 MiB size: 499.7 MiB (99.95%) used: 26.3 MiB (5.3%) fs: vfat 
           block-size: 512 B dev: /dev/sdb1 maj-min: 8:17 
           ID-3: /tmp raw-size: N/A size: 710.52 GiB used: 75.5 MiB (0.0%) fs: zfs 
...
Info:      Processes: 559 
           Uptime: 12:48:14  up 8 days 12:43,  1 user,  load average: 0.25, 0.07, 0.02 wakeups: 0 
