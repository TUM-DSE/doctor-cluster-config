...
```
System:    Host: bill Kernel: 6.4.16 x86_64 bits: 64 compiler: gcc v: 12.2.0 
           parameters: initrd=\efi\nixos\b0ndhk5bvncjwp75nddj4lanmpknp7mf-initrd-linux-6.4.16-initrd.efi 
           init=/nix/store/ihijk2q8cnv3f12l617rh6ajjd70d29a-nixos-system-bill-23.05.20230917.67f6c1e/init 
...
Memory:    RAM: total: 125.67 GiB used: 88.53 GiB (70.4%) 
...
CPU:       Info: 10-Core model: Intel Core i9-10900K bits: 64 type: MT MCP arch: Comet Lake 
           ...
           ext-clock: 100 MHz Core speeds (MHz): 1: 800 2: 800 3: 800 4: 800 5: 800 6: 5100 7: 800 
           8: 800 9: 800 10: 800 11: 800 12: 800 13: 800 14: 800 15: 800 16: 800 17: 800 18: 800 
           19: 800 20: 800 
...
Network:   Device-1: Intel Ethernet I219-LM vendor: Super Micro driver: e1000e v: kernel 
           ...
           IF-ID-3: br-9445ed3d463d state: down mac: 02:42:eb:e5:36:52 
           IP v4: 192.168.49.1/24 scope: global broadcast: 192.168.49.255 
           IF-ID-4: docker0 state: down mac: 02:42:c8:85:a1:29 
...
RAID:      Device-1: zpool1 type: zfs status: ONLINE level: linear size: 3.48 TiB free: 2.61 TiB 
           allocated: 897 GiB 
           Components: Online: N/A 
           Device-2: zpool2 type: zfs status: ONLINE level: linear size: 14.5 TiB free: 13.3 TiB 
           allocated: 1.24 TiB 
           Components: Online: N/A 
           Device-3: zroot type: zfs status: ONLINE level: linear size: 888 GiB free: 727 GiB 
           allocated: 161 GiB 
           Components: Online: N/A 
Drives:    Local Storage: total: raw: 18.92 TiB usable: 37.77 TiB used: 2.02 TiB (5.3%) 
           ...
           rotation: SSD serial: S667NJ0T748763 rev: GDC7302Q temp: 36 ° (309 K) C scheme: GPT 
           SMART: yes health: PASSED on: 50d 22h cycles: 5 read-units: 16,271,425 [8.33 TB] 
           written-units: 6,319,221 [3.23 TB] 
           ...
           SMART: yes state: enabled health: PASSED on: 1y 311d 6h cycles: 5 
           ...
           scheme: GPT 
           SMART: yes state: enabled health: PASSED on: 2y 173d 19h cycles: 40 read: 28.06 TiB 
           written: 57.34 TiB 
           ...
           SMART: yes state: enabled health: PASSED on: 1y 311d 6h cycles: 5 
Partition: ID-1: / raw-size: N/A size: 803.16 GiB used: 105.11 GiB (13.1%) fs: zfs 
           logical: zroot/root/nixos 
           ID-2: /boot raw-size: 500 MiB size: 499.7 MiB (99.95%) used: 223.4 MiB (44.7%) fs: vfat 
           block-size: 512 B dev: /dev/sdb1 maj-min: 8:17 
           ID-3: /tmp raw-size: N/A size: 698.04 GiB used: 1024 KiB (0.0%) fs: zfs 
...
Info:      Processes: 581 
           Uptime: 11:02:07  up 1 day 13:38,  0 users,  load average: 0.04, 0.02, 0.00 wakeups: 0 
