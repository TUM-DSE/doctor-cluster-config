...
```
System:
  Host: mickey Kernel: 6.12.10 arch: x86_64 bits: 64 compiler: gcc v: 13.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\g07hgvdfi4kbn6k5inlv1n5hdwxw2wqd-initrd-linux-6.12.10-initrd.efi
    init=/nix/store/na1z5hmbdgjxcjkv1vp28ir9n5rqggql-nixos-system-mickey-24.11.20250120.643e964/init
...
Memory:
  System RAM: total: 128 GiB available: 125.51 GiB used: 52 GiB (41.4%)
...
CPU:
  ...
  Speed (MHz): avg: 2200 high: 2500 min/max: N/A base/boost: 2500/4000 volts: 1.8 V
    ext-clock: 10400 MHz cores: 1: 2500 2: 2500 3: 2500 4: 1000 5: 2500 6: 2500 7: 2500 8: 1003
    9: 1000 10: 2500 11: 2500 12: 2500 13: 2500 14: 2500 15: 2500 16: 2500 17: 2500 18: 2500
    19: 2500 20: 1000 21: 2500 22: 1000 23: 1000 24: 2500 25: 2500 26: 2500 27: 2500 28: 2500
    29: 2500 30: 2500 31: 1000 32: 2500 33: 2500 34: 2500 35: 2500 36: 2500 37: 2500 38: 1000
...
Network:
  ...
  IF-ID-1: cni0 state: up speed: 10000 Mbps duplex: unknown mac: d2:bb:2f:2d:34:0c
  IP v4: 10.42.1.1/24 scope: global broadcast: 10.42.1.255
  IP v6: fe80::d0bb:2fff:fe2d:340c/64 virtual: proto kernel_ll scope: link
  IF-ID-2: docker0 state: down mac: 02:42:ef:90:56:11
  ...
  IF-ID-4: vethfc7054e8 state: up speed: 10000 Mbps duplex: full mac: 92:9a:2a:18:18:dc
...
RAID:
  ...
  Device-2: nfs-home type: zfs status: ONLINE level: linear raw: size: 3.48 TiB free: 982 GiB
    allocated: 2.53 TiB zfs-fs: size: 3.38 TiB free: 871.15 GiB
  Components: Online:
  1: nvme1n1p1 maj-min: 259:4 size: 3.49 TiB
  Device-3: zroot type: zfs status: ONLINE level: linear raw: size: 1.45 TiB free: 1.3 TiB
    allocated: 154 GiB zfs-fs: size: 1.41 TiB free: 1.26 TiB
  Components: Online:
  1: nvme0n1p2 maj-min: 259:2 size: 1.45 TiB
Drives:
  Local Storage: total: raw: 19.5 TiB usable: 19.19 TiB used: 6.24 TiB (32.5%)
  ...
  SMART: yes health: PASSED on: 3y 25d 15h cycles: 30 read-units: 14,617,870 [7.48 TB]
    written-units: 114,318,700 [58.5 TB]
  ID-2: /dev/nvme1n1 maj-min: 259:3 vendor: Samsung model: MZQL23T8HCLS-00A07 size: 3.49 TiB
    ...
    serial: S64HNT0X115369 fw-rev: GDC5A02Q temp: 34.9 C scheme: GPT
  SMART: yes health: PASSED on: 300d 21h cycles: 15 read-units: 42,837,618 [21.9 TB]
    written-units: 27,838,067 [14.2 TB]
  ...
  SMART: yes state: enabled health: PASSED on: 300d 20h cycles: 15 written: 3.09 TiB
  ...
  SMART: yes state: enabled health: PASSED on: 300d 20h cycles: 15 written: 3.08 TiB
Partition:
  ID-1: / raw-size: N/A size: 1.29 TiB used: 35.93 GiB (2.7%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 73.8 MiB (7.2%) fs: vfat
    block-size: 512 B dev: /dev/nvme0n1p1 maj-min: 259:1
  ID-3: /tmp raw-size: N/A size: 1.26 TiB used: 1.6 MiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu: N/A mobo: N/A
  Fan Speeds (rpm): cpu: 6120 fan-26: 4680 fan-42: 4680 fan-43: 5040 fan-58: 4920 fan-59: 5280
    fan-74: 4920 fan-75: 5280 fan-90: 4920 fan-91: 5160 fan-106: 4920 fan-107: 6360
  Power: 12v: N/A 5v: N/A 3.3v: N/A vbat: N/A dimm-p1: N/A dimm-p2: N/A
  Src: lm-sensors System Temperatures: cpu: 75.0 C pch: 40.0 C mobo: N/A
  Fan Speeds (rpm): N/A
Info:
  Processes: 1047 Power: uptime: 23d 11h 49m states: freeze,mem suspend: s2idle wakeups: 0
