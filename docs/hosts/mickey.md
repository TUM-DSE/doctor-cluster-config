...
```
System:
  Host: mickey Kernel: 6.16.9 arch: x86_64 bits: 64 compiler: gcc v: 14.3.0 clocksource: tsc
    avail: hpet,acpi_pm
    parameters: initrd=\EFI\nixos\4nw7j235jav2x02pakhbj1m2435qkq6m-initrd-linux-6.16.9-initrd.efi
    init=/nix/store/lh4bmdww2w0bf2wyz18b0ypv3sbw1n77-nixos-system-mickey-25.05.20250930.51fcc5b/init
...
Memory:
  System RAM: total: 128 GiB available: 125.51 GiB used: 89.8 GiB (71.6%)
...
CPU:
  ...
  Speed (MHz): avg: 2237 high: 2500 min/max: N/A base/boost: 2500/4000 volts: 1.8 V
    ext-clock: 10400 MHz cores: 1: 1000 2: 2500 3: 2500 4: 2500 5: 2500 6: 1000 7: 2500 8: 2500
    9: 1000 10: 2500 11: 1000 12: 2500 13: 2500 14: 2500 15: 1000 16: 2500 17: 2500 18: 1000
...
Network:
  ...
  IF-ID-1: cni0 state: up speed: 10000 Mbps duplex: unknown mac: d6:c8:8f:9a:72:44
  IP v4: 10.42.1.1/24 scope: global broadcast: 10.42.1.255
  IP v6: fe80::d4c8:8fff:fe9a:7244/64 virtual: proto kernel_ll scope: link
  IF-ID-2: docker0 state: down mac: 02:42:01:e8:32:fc
  ...
  IF-ID-4: veth130c1232 state: up speed: 10000 Mbps duplex: full mac: 1a:43:2b:03:f6:ac
  IF-ID-5: veth26df9cec state: up speed: 10000 Mbps duplex: full mac: 72:2f:e1:43:35:3b
  IF-ID-6: veth4981bc5a state: up speed: 10000 Mbps duplex: full mac: 5a:41:bf:56:fc:d2
  IF-ID-7: veth64c59068 state: up speed: 10000 Mbps duplex: full mac: 8a:de:ab:a3:26:43
  IF-ID-8: veth859784b6 state: up speed: 10000 Mbps duplex: full mac: 56:50:f3:2e:39:68
  IF-ID-9: veth9b2c863f state: up speed: 10000 Mbps duplex: full mac: 22:95:12:6e:5f:01
...
RAID:
  ...
  Device-1: nfs-data type: zfs status: ONLINE level: linear raw: size: 14.5 TiB free: 10.1 TiB
    allocated: 4.43 TiB zfs-fs: size: 14.42 TiB free: 9.98 TiB
  Components: Online:
  1: sda1 maj-min: 8:1 size: 7.28 TiB
  2: sdb1 maj-min: 8:17 size: 7.28 TiB
  Device-2: nfs-home type: zfs status: ONLINE level: linear raw: size: 3.48 TiB free: 1.93 TiB
    allocated: 1.56 TiB zfs-fs: size: 3.43 TiB free: 1.82 TiB
  Components: Online:
  1: nvme0n1p1 maj-min: 259:4 size: 3.49 TiB
  Device-3: zroot type: zfs status: ONLINE level: linear raw: size: 1.45 TiB free: 1.28 TiB
    allocated: 177 GiB zfs-fs: size: 1.41 TiB free: 1.24 TiB
  Components: Online:
  1: nvme1n1p2 maj-min: 259:2 size: 1.45 TiB
Drives:
  Local Storage: total: raw: 19.5 TiB usable: 19.26 TiB used: 6.1 TiB (31.7%)
  ...
  SMART: yes health: PASSED on: 1y 188d 3h cycles: 17 read-units: 113,329,714 [58.0 TB]
    written-units: 67,231,794 [34.4 TB]
  ID-2: /dev/nvme1n1 maj-min: 259:0 vendor: Dell model: Ent NVMe P5600 MU U.2 1.6TB
    ...
    serial: PHAB1233010E1P9SGN fw-rev: 1.1.5 temp: 32.9 C scheme: GPT
  SMART: yes health: PASSED on: 3y 277d 19h cycles: 32 read-units: 18,305,874 [9.37 TB]
    written-units: 143,338,896 [73.3 TB]
  ID-3: /dev/sda maj-min: 8:0 vendor: Samsung model: SSD 870 QVO 8TB family: based SSDs
    ...
    serial: S5SSNJ0X300228R fw-rev: 2B6Q temp: 21 C scheme: GPT
  SMART: yes state: enabled health: PASSED on: 1y 188d 2h cycles: 17 written: 3.56 TiB
  ID-4: /dev/sdb maj-min: 8:16 vendor: Samsung model: SSD 870 QVO 8TB family: based SSDs
    size: 7.28 TiB block-size: physical: 512 B logical: 512 B sata: 3.3 speed: <unknown> tech: SSD
    serial: S5SSNJ0X300181Y fw-rev: 2B6Q temp: 21 C scheme: GPT
  SMART: yes state: enabled health: PASSED on: 1y 188d 2h cycles: 17 written: 3.55 TiB
Partition:
  ID-1: / raw-size: N/A size: 1.28 TiB used: 45.46 GiB (3.5%) fs: zfs logical: zroot/root/nixos
  ID-2: /boot raw-size: 1024 MiB size: 1022 MiB (99.80%) used: 44.2 MiB (4.3%) fs: vfat
    block-size: 512 B dev: /dev/nvme1n1p1 maj-min: 259:1
  ID-3: /tmp raw-size: N/A size: 1.24 TiB used: 256 KiB (0.0%) fs: zfs logical: zroot/root/tmp
Swap:
  Alert: No swap data was found.
Sensors:
  Src: ipmi System Temperatures: cpu: N/A mobo: N/A
  Fan Speeds (rpm): cpu: 5520 fan-26: 4080 fan-42: 4080 fan-43: 4440 fan-58: 4440 fan-59: 4800
    fan-74: 4800 fan-75: 5160 fan-90: 4800 fan-91: 5040 fan-106: 4680 fan-107: 6120
  ...
  Fan Speeds (rpm): N/A
Info:
  Processes: 970 Power: uptime: 3d 15h 59m states: freeze,mem suspend: s2idle wakeups: 0
    hibernate: disabled image: 50.19 GiB Init: systemd v: 257 default: multi-user tool: systemctl
  Packages: pm: nix-default pkgs: 0 pm: nix-sys pkgs: 627 libs: 138 pm: nix-usr pkgs: 0
