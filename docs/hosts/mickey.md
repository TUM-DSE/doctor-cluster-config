...
```
System:    Host: mickey Kernel: 6.5.9 x86_64 bits: 64 compiler: gcc v: 12.2.0 
           parameters: initrd=\efi\nixos\63q9zsm96w25jsqk4jz35j0vss8a5iz7-initrd-linux-6.5.9-initrd.efi 
           init=/nix/store/rsv8vlvl801b4hl21lhkc0an087fbaci-nixos-system-mickey-23.05.20231027.0517940/init 
...
Machine:   Type: Server System: Dell product: PowerEdge R440 v: N/A serial: 3YBVXK3 Chassis: 
           ...
           date: 07/09/2021 
Memory:    RAM: total: 125.52 GiB used: 14.36 GiB (11.4%) 
...
CPU:       Info: 2x 10-Core model: Intel Xeon Gold 5215 socket: LGA2011 bits: 64 type: MT MCP SMP 
           ...
           18: 2500 19: 2500 20: 2500 21: 1000 22: 2500 23: 2500 24: 3200 25: 2500 26: 2500 
...
Network:   Device-1: Broadcom NetXtreme BCM5720 Gigabit Ethernet PCIe vendor: Dell driver: tg3 
           ...
           IF-ID-1: cni0 state: up speed: 10000 Mbps duplex: unknown mac: ca:0b:0d:ff:57:cf 
           IP v4: 10.42.2.1/24 scope: global broadcast: 10.42.2.255 
           IP v6: fe80::c80b:dff:feff:57cf/64 scope: link 
           IF-ID-2: docker0 state: down mac: 02:42:c4:73:03:f9 
           ...
           IF-ID-4: vetha5a23f37 state: up speed: 10000 Mbps duplex: full mac: 5e:d0:36:b5:f6:db 
           IF-ID-5: vethb8ae03da state: up speed: 10000 Mbps duplex: full mac: c6:5f:5e:d7:61:e7 
           IF-ID-6: vethf6aba6b8 state: up speed: 10000 Mbps duplex: full mac: 6e:c9:f8:77:e5:fb 
...
Drives:    Local Storage: total: 1.46 TiB used: 2.22 TiB (152.6%) 
           ...
           SMART: yes health: PASSED on: 1y 286d 18h cycles: 17 read-units: 8,560,325 [4.38 TB] 
           written-units: 64,920,402 [33.2 TB] 
Partition: ID-1: / raw-size: N/A size: 1.4 TiB used: 23.5 GiB (1.6%) fs: zfs 
...
Info:      Processes: 703 
           Uptime: 09:11:39  up 10 days  8:53,  0 users,  load average: 0.06, 0.10, 0.09 
