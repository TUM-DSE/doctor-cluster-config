...
```
System:    Host: mickey Kernel: 6.0.19 x86_64 bits: 64 compiler: gcc v: 11.3.0 
           parameters: initrd=\efi\nixos\9hgr7n438j095a3ybsxnfkvq1apbyrij-initrd-linux-6.0.19-initrd.efi 
           init=/nix/store/vn9157hrxl6nznjg0v6xrw0vk4wsv16f-nixos-system-mickey-22.11.20230120.aaa0f4f/init 
...
CPU:       Info: 2x 10-Core model: Intel Xeon Gold 5215 socket: LGA2011 bits: 64 type: MT MCP SMP 
           ...
           27: 2500 28: 2500 29: 2500 30: 2500 31: 1000 32: 2500 33: 2500 34: 2500 35: 2500 
...
Network:   Device-1: Broadcom NetXtreme BCM5720 Gigabit Ethernet PCIe vendor: Dell driver: tg3 
           ...
           IF-ID-1: cni0 state: up speed: 10000 Mbps duplex: unknown mac: 56:19:c2:24:36:d8 
           IP v4: 10.42.4.1/24 scope: global broadcast: 10.42.4.255 
           IP v6: fe80::5419:c2ff:fe24:36d8/64 scope: link 
           IF-ID-2: docker0 state: down mac: 02:42:89:c7:db:2e 
           ...
           IF-ID-4: vethd0450082 state: up speed: 10000 Mbps duplex: full mac: 8e:68:26:d3:b6:82 
...
Drives:    Local Storage: total: raw: 1.46 TiB usable: 2.91 TiB used: 1.08 TiB (37.2%) 
           ...
           SMART: yes health: PASSED on: 1y 21d 2h cycles: 15 read-units: 4,726,975 [2.42 TB] 
           written-units: 35,332,819 [18.0 TB] 
Partition: ID-1: / raw-size: N/A size: 1.39 TiB used: 25.63 GiB (1.8%) fs: zfs 
...
Info:      Processes: 575 
           Uptime: 14:25:38  up 16 days 14:22,  0 users,  load average: 0.14, 0.15, 0.18 
