...
```
System:    Host: mickey Kernel: 6.4.16 x86_64 bits: 64 compiler: gcc v: 12.2.0 
           parameters: initrd=\efi\nixos\zkagvq3rl0qrdxhhdzgzfiqvzmyki9ri-initrd-linux-6.4.16-initrd.efi 
           init=/nix/store/b82x37k1j1z9dkm3s8nzlcnxvazfynw4-nixos-system-mickey-23.05.20230927.3048712/init 
...
Machine:   Type: Server System: Dell product: PowerEdge R440 v: N/A serial: 3YBVXK3 Chassis: 
           ...
           date: 07/09/2021 
Memory:    RAM: total: 125.52 GiB used: 12.4 GiB (9.9%) 
...
CPU:       Info: 2x 10-Core model: Intel Xeon Gold 5215 socket: LGA2011 bits: 64 type: MT MCP SMP 
           ...
           9: 2500 10: 2500 11: 2500 12: 1000 13: 1000 14: 2500 15: 1000 16: 1001 17: 2500 
           ...
           36: 2500 37: 2500 38: 2500 39: 1000 40: 2500 
...
Network:   Device-1: Broadcom NetXtreme BCM5720 Gigabit Ethernet PCIe vendor: Dell driver: tg3 
           ...
           IF-ID-1: cni0 state: up speed: 10000 Mbps duplex: unknown mac: de:2f:30:e5:e6:7e 
           IP v4: 10.42.2.1/24 scope: global broadcast: 10.42.2.255 
           IP v6: fe80::3800:45ff:fe2c:bee5/64 scope: link 
           IF-ID-2: docker0 state: down mac: 02:42:5c:fa:e4:0c 
           ...
           IF-ID-4: veth1acee539 state: up speed: 10000 Mbps duplex: full mac: ea:f6:cc:37:75:10 
           IF-ID-5: veth3bb90683 state: up speed: 10000 Mbps duplex: full mac: de:9c:76:c3:b0:06 
           IF-ID-6: veth521a24e9 state: up speed: 10000 Mbps duplex: full mac: a2:9b:ee:44:1b:b5 
           IF-ID-7: veth7524e60c state: up speed: 10000 Mbps duplex: full mac: de:e7:fe:ff:6a:8e 
...
Drives:    Local Storage: total: raw: 1.46 TiB usable: 2.91 TiB used: 22.05 GiB (0.7%) 
           ...
           SMART: yes health: PASSED on: 1y 267d 22h cycles: 17 read-units: 8,373,610 [4.28 TB] 
           written-units: 62,084,844 [31.7 TB] 
Partition: ID-1: / raw-size: N/A size: 1.41 TiB used: 19.32 GiB (1.3%) fs: zfs 
...
Info:      Processes: 690 
           Uptime: 13:02:20  up 19 days 12:56,  0 users,  load average: 0.12, 0.10, 0.09 
